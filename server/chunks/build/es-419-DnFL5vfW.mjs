//#region i18n/locales/es-419.json
var resource = {
	"$schema": {
		"t": 0,
		"b": {
	...
	"blog": { "atproto": { "like_or_reply_on_bluesky": {
		...
		"b": {
			"t": 2,
			"i": [{ "t": 3 }],
			"s": "Dale me gusta a esta publicación o agrega tu comentario en Bluesky"
		}
	} } },
		...
		"not_found_message": {
			...
			"b": {
				...
				"i": [
					{
						"t": 3,
						"v": "No se pudo encontrar el perfil de "
					},
					{
						"t": 4,
						"k": "handle"
		...
		"invite": {
			"message": {
				...
				"b": {
					"t": 2,
					"i": [{ "t": 3 }],
					"s": "Parece que aún no usa npmx. ¿Quieres contarle?"
				}
			},
			"compose_text": {
				"t": 0,
			...
			"facet_bar_general_description": {
				...
				"b": {
					...
					"i": [
						{
							"t": 3,
							"v": "Gráfica de barras horizontal para: "
						},
						{
							"t": 4,
							"k": "packages"
	...
	"pds": {
		"join": { "description": {
			...
			"b": {
				"t": 2,
				"i": [{ "t": 3 }],
				"s": "Ya sea que estés creando tu primera cuenta en la atmósfera o migrando una existente, tu lugar está aquí. Puedes migrar tu cuenta actual sin perder tu usuario, tus publicaciones o tus seguidores."
			}
		} },
		"server": { "learn_more": {
			"t": 0,
			"b": {
				"t": 2,
				"i": [{ "t": 3 }],
				"s": "Conoce cómo npmx usa la Atmósfera"
			}
		} }
	},
	"a11y": { "welcome": {
...
//# sourceMappingURL=es-419-DnFL5vfW.mjs.map
