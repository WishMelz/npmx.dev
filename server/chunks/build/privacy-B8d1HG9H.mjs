import { u as useI18n, a as useSeoMeta$1, q as useAppConfig, U as _sfc_main, n as nuxt_link_default } from './server-placeholder-C9fYItBT.mjs';
...
var privacy_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(`</header><section class="max-w-none space-y-8"><p class="text-fg-muted leading-relaxed">`);
			_push(ssrRenderComponent(_component_i18n_t, {
...
//# sourceMappingURL=privacy-B8d1HG9H.mjs.map
