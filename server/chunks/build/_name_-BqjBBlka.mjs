import { _ as _plugin_vue_export_helper_default, u as useI18n, a1 as useEventListener, P as useClipboard, k as createError$1, X as showError, c as useNuxtApp, d as useRoute, Y as useHead$1, a as useSeoMeta$1, a6 as page_default, m as Base_default$1, o as client_only_default, B as Base_default, R as DateTime_default, a7 as useMounted, a5 as useMediaQuery, L as onClickOutside, n as nuxt_link_default, w as packageRoute, a8 as useWindowScroll, a0 as useElementBounding, i as useRouter, x as useSettings, V as useAccentColor, S as useColorMode, C as useKeyboardShortcuts, D as onKeyDown, t as Base_default$2, p as useGlobalSearch, z as useConnector, a4 as createSharedComposable, a9 as useLocalStorage, aa as useWindowSize, y as onPrehydrate, J as server_placeholder_default, T as useElementSize } from './server-placeholder-C9fYItBT.mjs';
import { u as useLazyFetch, a as useFetch } from './fetch-CVxFI0ck.mjs';
import { u as useResolvedVersion, a as useRepositoryUrl, b as useRepoMeta } from './useRepoMeta-BtIq7MgE.mjs';
import { u as usePackage, p as parseNodeScript } from './usePackage-RzwDULD4.mjs';
import { d as defineOgImageComponent } from './defineOgImageComponent-AYn-m8kF.mjs';
import { A as App_default } from './App-BNEn-XjJ.mjs';
import { d as downloadFileLink } from './download-BhcGnbTM.mjs';
import { S as Static_default } from './Static-k7Eg8Ng9.mjs';
import { g as getDependencyCount, u as useCssVariables, d as lightenOklch, e as applyBlocklistCorrection, f as applyDataCorrection, T as TrendsChart_default, h as fetchAllPackageVersions, a as applyEllipsis, t as transparentizeOklch, j as copyAltTextForVersionsBarChart, l as loadFile, s as sanitise } from './TrendsChart-jAJHm3WC.mjs';
import { u as useNumberFormatter, b as useBytesFormatter, a as useCompactNumberFormatter } from './useNumberFormatter-6MIdB6Qd.mjs';
...
import { a as useModal } from './likes-xTtdlbfa.mjs';
import { u as usePackageHeaderHeight, a as usePackageRoute, H as Header_default } from './Header-ca9VNABN.mjs';
import { b as buildVersionToTagsMap, f as filterVersions, g as getPrereleaseChannel, i as isSameVersionGroup, a as getVersionGroupKey, c as getVersionGroupLabel, d as filterExcludedTags } from './versions-c9k_hFa5.mjs';
...
import { R as Readme_default } from './Readme-DDyiOEPy.mjs';
import { A as Avatar_default } from './Avatar-CzrXdCa1.mjs';
import { defineComponent, useTemplateRef, shallowRef, computed, withAsyncContext, watch, resolveComponent, unref, withCtx, createVNode, toDisplayString, createTextVNode, openBlock, createBlock, createCommentVNode, toValue, mergeProps, resolveDynamicComponent, renderSlot, useId, ref, Transition, Fragment, renderList, isRef, withDirectives, vShow, withModifiers, nextTick, useSSRContext } from 'vue';
import { y as assertValidPackageName, b8 as isBinaryOnlyPackage, b9 as isCreatePackage, v as encodePackageName, ba as areUrlsEquivalent, bb as parseLicenseExpression, bc as NPMX_DOCS_SITE, bd as SEVERITY_TEXT_COLORS, be as getHighestSeverity, bf as getCreateShortName } from '../nitro/nitro.mjs';
import { ssrRenderComponent, ssrRenderClass, ssrInterpolate, ssrRenderAttr, ssrRenderStyle, ssrRenderList, ssrRenderAttrs, ssrRenderVNode, ssrRenderSlot, ssrRenderTeleport, ssrIncludeBooleanAttr } from 'vue/server-renderer';
...
import './frameworks-hCp8-s9f.mjs';
...
//#region node_modules/.pnpm/nuxt@4.3.1_@parcel+watcher@2.5.4_@types+node@24.12.0_@upstash+redis@1.37.0_@vue+compile_f0cd0552faee97afd8a1bbd3deb1c7f3/node_modules/nuxt/dist/app/components/dev-only.js
var dev_only_default = defineComponent({
	name: "DevOnly",
	inheritAttrs: false,
	setup(_, props) {
...
//#endregion
//#region app/components/Package/Skeleton.vue
var _sfc_main = {};
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
	const _component_SkeletonInline = SkeletonInline_default;
	const _component_SkeletonBlock = SkeletonBlock_default;
	_push(`<!--[--><header class="bg-bg pt-6 pb-2 pb-1 w-full container" data-v-7c7ff4be><div class="flex items-baseline justify-between gap-x-2 gap-y-1 flex-wrap min-w-0" data-v-7c7ff4be><h1 class="font-mono text-2xl sm:text-3xl font-medium" data-v-7c7ff4be>`);
	_push(ssrRenderComponent(_component_SkeletonInline, { class: "block! h-9 w-48" }, null, _parent));
	_push(`</h1><div class="flex gap-2 flex-wrap items-stretch" data-v-7c7ff4be>`);
	_push(ssrRenderComponent(_component_SkeletonBlock, { class: "w-9 md:w-36 h-9 rounded" }, null, _parent));
	_push(ssrRenderComponent(_component_SkeletonBlock, { class: "w-14 h-9 rounded" }, null, _parent));
	_push(ssrRenderComponent(_component_SkeletonBlock, { class: "w-22 h-9 rounded self-baseline" }, null, _parent));
	_push(`</div></div></header><div class="w-full bg-bg sticky top-14 z-10 border-b border-border pt-2" data-v-7c7ff4be><div class="w-full container flex flex-col md:flex-row-reverse flex-wrap gap-2 justify-between" data-v-7c7ff4be><span class="inline-flex items-baseline font-mono text-base sm:text-lg shrink-0" data-v-7c7ff4be>`);
	_push(ssrRenderComponent(_component_SkeletonInline, { class: "h-6 w-20" }, null, _parent));
	_push(`</span><div class="flex items-center gap-0.5 p-0.5" data-v-7c7ff4be>`);
	...
	_push(`</div></div></div><article aria-busy="true"${ssrRenderAttr("aria-label", _ctx.$t("package.skeleton.loading"))} class="package-page motion-safe:animate-fade-in container w-full" data-v-7c7ff4be><section class="area-details pt-4" data-v-7c7ff4be><div class="mb-4" data-v-7c7ff4be><div class="max-w-2xl" data-v-7c7ff4be><div class="space-y-2" data-v-7c7ff4be>`);
	...
	_push(`</div></div><ul class="flex flex-wrap items-center gap-x-3 gap-y-1.5 sm:gap-4 list-none m-0 p-0 mt-3 text-sm" data-v-7c7ff4be><li data-v-7c7ff4be>`);
	_push(ssrRenderComponent(_component_SkeletonInline, { class: "h-5 w-28" }, null, _parent));
	_push(`</li><li data-v-7c7ff4be>`);
	...
	_push(`</li></ul><div class="basis-full flex gap-2 sm:gap-3 flex-wrap items-stretch mt-4" data-v-7c7ff4be><div class="flex items-center gap-1.5 self-baseline" data-v-7c7ff4be>`);
	...
	_push(`</div></div></div><dl class="grid grid-cols-2 sm:grid-cols-7 md:grid-cols-11 gap-3 sm:gap-4 py-4 sm:py-6 mt-4 sm:mt-6 border-t border-b border-border" data-v-7c7ff4be><div class="space-y-1 sm:col-span-2" data-v-7c7ff4be><dt class="text-xs text-fg-subtle uppercase tracking-wider" data-v-7c7ff4be>${ssrInterpolate(_ctx.$t("package.stats.license"))}</dt><dd class="font-mono text-sm" data-v-7c7ff4be>`);
	_push(ssrRenderComponent(_component_SkeletonInline, { class: "h-5 w-12" }, null, _parent));
	_push(`</dd></div><div class="space-y-1 sm:col-span-2" data-v-7c7ff4be><dt class="text-xs text-fg-subtle uppercase tracking-wider" data-v-7c7ff4be>${ssrInterpolate(_ctx.$t("package.stats.deps"))}</dt><dd class="font-mono text-sm" data-v-7c7ff4be>`);
	_push(ssrRenderComponent(_component_SkeletonInline, { class: "h-5 w-12" }, null, _parent));
	_push(`</dd></div><div class="space-y-1 sm:col-span-3" data-v-7c7ff4be><dt class="text-xs text-fg-subtle uppercase tracking-wider" data-v-7c7ff4be>${ssrInterpolate(_ctx.$t("package.stats.install_size"))}</dt><dd class="font-mono text-sm" data-v-7c7ff4be>`);
	_push(ssrRenderComponent(_component_SkeletonInline, { class: "h-5 w-16" }, null, _parent));
	_push(`</dd></div><div class="space-y-1 sm:col-span-2" data-v-7c7ff4be><dt class="text-xs text-fg-subtle uppercase tracking-wider" data-v-7c7ff4be>${ssrInterpolate(_ctx.$t("package.stats.vulns"))}</dt><dd class="font-mono text-sm text-fg-subtle" data-v-7c7ff4be>-</dd></div><div class="space-y-1 sm:col-span-2" data-v-7c7ff4be><dt class="text-xs text-fg-subtle uppercase tracking-wider" data-v-7c7ff4be>${ssrInterpolate(_ctx.$t("package.stats.published"))}</dt><dd class="font-mono text-sm" data-v-7c7ff4be>`);
	_push(ssrRenderComponent(_component_SkeletonInline, { class: "h-5 w-28" }, null, _parent));
	_push(`</dd></div></dl></section><section class="area-install scroll-mt-20" data-v-7c7ff4be><div class="flex flex-wrap items-center justify-between mb-3" data-v-7c7ff4be><h2 class="text-xs font-mono text-fg-subtle uppercase tracking-wider" data-v-7c7ff4be>${ssrInterpolate(_ctx.$t("package.get_started.title"))}</h2><div class="flex items-center gap-2" data-v-7c7ff4be>`);
	_push(ssrRenderComponent(_component_SkeletonInline, { class: "h-7 w-24 rounded" }, null, _parent));
	_push(ssrRenderComponent(_component_SkeletonInline, { class: "h-7 w-24 rounded" }, null, _parent));
	_push(`</div></div><div class="bg-bg-subtle border border-border rounded-lg overflow-hidden" data-v-7c7ff4be><div class="flex gap-1.5 px-3 pt-2 sm:px-4 sm:pt-3" data-v-7c7ff4be><span class="w-2.5 h-2.5 rounded-full bg-fg-subtle" data-v-7c7ff4be></span><span class="w-2.5 h-2.5 rounded-full bg-fg-subtle" data-v-7c7ff4be></span><span class="w-2.5 h-2.5 rounded-full bg-fg-subtle" data-v-7c7ff4be></span></div><div class="px-3 pt-2 pb-3 sm:px-4 sm:pt-3 sm:pb-4 space-y-1" data-v-7c7ff4be><div class="flex items-center gap-2" data-v-7c7ff4be><span class="text-fg-subtle font-mono text-sm select-none shrink-0" data-v-7c7ff4be>\$</span>`);
	_push(ssrRenderComponent(_component_SkeletonInline, { class: "h-5 w-40" }, null, _parent));
	_push(`</div><div class="flex items-center gap-2 pt-1" data-v-7c7ff4be>`);
	_push(ssrRenderComponent(_component_SkeletonInline, { class: "h-4 w-24" }, null, _parent));
	_push(`</div><div class="flex items-center gap-2" data-v-7c7ff4be><span class="text-fg-subtle font-mono text-sm select-none shrink-0" data-v-7c7ff4be>\$</span>`);
	_push(ssrRenderComponent(_component_SkeletonInline, { class: "h-5 w-28" }, null, _parent));
	_push(`</div><div class="flex items-center gap-2 pt-1" data-v-7c7ff4be>`);
	...
	_push(`</div></div></div></section><div class="area-vulns" data-v-7c7ff4be></div><div class="area-sidebar" data-v-7c7ff4be><div class="space-y-6 sm:space-y-8 min-w-0 lg:max-h-[calc(100dvh-8.5rem)] lg:overscroll-contain xl:max-h-[calc(100dvh-6rem)]" data-v-7c7ff4be><div class="flex flex-col gap-4 sm:gap-6 xl:pt-4" data-v-7c7ff4be><section data-v-7c7ff4be><div class="flex items-center justify-between mb-3 px-1" data-v-7c7ff4be><h2 class="text-xs font-mono text-fg-subtle uppercase tracking-wider flex items-center gap-2" data-v-7c7ff4be><span class="w-4 h-4 flex items-center justify-center shrink-0" data-v-7c7ff4be><span class="i-lucide:chevron-down w-3 h-3" aria-hidden="true" data-v-7c7ff4be></span></span> ${ssrInterpolate(_ctx.$t("package.downloads.title"))}</h2></div><div class="ms-6 max-w-xs" data-v-7c7ff4be><div class="h-6 flex items-center ps-3" data-v-7c7ff4be>`);
	_push(ssrRenderComponent(_component_SkeletonInline, { class: "h-3 w-36" }, null, _parent));
	_push(`</div><div class="aspect-[500/80] flex items-center" data-v-7c7ff4be><div class="w-[42%] flex items-center ps-0.5" data-v-7c7ff4be>`);
	_push(ssrRenderComponent(_component_SkeletonInline, { class: "h-7 w-24" }, null, _parent));
	_push(`</div><div class="flex-1 flex items-end pe-3" data-v-7c7ff4be>`);
	_push(ssrRenderComponent(_component_SkeletonInline, { class: "h-px w-full" }, null, _parent));
	_push(`</div></div></div></section><section class="px-1" data-v-7c7ff4be><h2 class="text-xs font-mono text-fg-subtle uppercase tracking-wider mb-3" data-v-7c7ff4be>${ssrInterpolate(_ctx.$t("package.playgrounds.title"))}</h2>`);
	_push(ssrRenderComponent(_component_SkeletonBlock, { class: "w-full h-9 rounded-md" }, null, _parent));
	_push(`</section><section data-v-7c7ff4be><div class="flex items-center justify-between mb-3 px-1" data-v-7c7ff4be><h2 class="text-xs font-mono text-fg-subtle uppercase tracking-wider flex items-center gap-2" data-v-7c7ff4be><span class="w-4 h-4 flex items-center justify-center shrink-0" data-v-7c7ff4be><span class="i-lucide:chevron-down w-3 h-3" aria-hidden="true" data-v-7c7ff4be></span></span> ${ssrInterpolate(_ctx.$t("package.compatibility"))}</h2></div><div class="ms-6 space-y-2" data-v-7c7ff4be><div class="flex justify-between gap-4 py-1" data-v-7c7ff4be>`);
	...
	_push(`</div></div></section><section data-v-7c7ff4be><div class="flex items-center justify-between mb-3 px-1" data-v-7c7ff4be><h2 class="text-xs font-mono text-fg-subtle uppercase tracking-wider flex items-center gap-2" data-v-7c7ff4be><span class="w-4 h-4 flex items-center justify-center shrink-0" data-v-7c7ff4be><span class="i-lucide:chevron-down w-3 h-3" aria-hidden="true" data-v-7c7ff4be></span></span> ${ssrInterpolate(_ctx.$t("package.skeleton.versions"))}</h2></div><div class="ms-6 space-y-0.5 min-w-0" data-v-7c7ff4be><!--[-->`);
	ssrRenderList(4, (i) => {
		_push(`<div class="flex items-center gap-2 px-1" data-v-7c7ff4be><span class="w-4 h-4 flex items-center justify-center shrink-0" data-v-7c7ff4be><span class="i-lucide:chevron-right w-3 h-3 text-fg-subtle" aria-hidden="true" data-v-7c7ff4be></span></span><div class="flex-1 py-1.5 min-w-0 flex gap-2 justify-between items-center" data-v-7c7ff4be><div data-v-7c7ff4be>`);
	...
	_push(`<!--]--><div class="flex items-center gap-2 p-1" data-v-7c7ff4be><span class="w-4 h-4 flex items-center justify-center shrink-0" data-v-7c7ff4be><span class="i-lucide:chevron-right w-3 h-3 text-fg-subtle" aria-hidden="true" data-v-7c7ff4be></span></span>`);
	_push(ssrRenderComponent(_component_SkeletonInline, { class: "h-3 w-28" }, null, _parent));
	_push(`</div></div></section><section data-v-7c7ff4be><div class="flex items-center justify-between mb-3 px-1" data-v-7c7ff4be><h2 class="text-xs font-mono text-fg-subtle uppercase tracking-wider flex items-center gap-2" data-v-7c7ff4be><span class="w-4 h-4 flex items-center justify-center shrink-0" data-v-7c7ff4be><span class="i-lucide:chevron-down w-3 h-3" aria-hidden="true" data-v-7c7ff4be></span></span> ${ssrInterpolate(_ctx.$t("package.skeleton.dependencies"))}</h2></div><ul class="ms-6 px-1 space-y-1 list-none m-0 p-0" data-v-7c7ff4be><li class="flex items-center justify-between py-1 text-sm" data-v-7c7ff4be>`);
	_push(ssrRenderComponent(_component_SkeletonInline, { class: "h-4 w-24" }, null, _parent));
	_push(ssrRenderComponent(_component_SkeletonInline, { class: "h-4 w-12" }, null, _parent));
	_push(`</li><li class="flex items-center justify-between py-1 text-sm" data-v-7c7ff4be>`);
	...
	_push(ssrRenderComponent(_component_SkeletonInline, { class: "h-4 w-12" }, null, _parent));
	_push(`</li></ul></section><section data-v-7c7ff4be><div class="flex items-center justify-between mb-3 px-1" data-v-7c7ff4be><h2 class="text-xs font-mono text-fg-subtle uppercase tracking-wider flex items-center gap-2" data-v-7c7ff4be><span class="w-4 h-4 flex items-center justify-center shrink-0" data-v-7c7ff4be><span class="i-lucide:chevron-down w-3 h-3" aria-hidden="true" data-v-7c7ff4be></span></span> ${ssrInterpolate(_ctx.$t("package.skeleton.keywords"))}</h2></div><ul class="ms-6 flex flex-wrap gap-1.5 list-none m-0 p-1" data-v-7c7ff4be><li data-v-7c7ff4be>`);
	...
	_push(`</li></ul></section><section data-v-7c7ff4be><div class="flex items-center justify-between mb-3 px-1" data-v-7c7ff4be><h2 class="text-xs font-mono text-fg-subtle uppercase tracking-wider flex items-center gap-2" data-v-7c7ff4be><span class="w-4 h-4 flex items-center justify-center shrink-0" data-v-7c7ff4be><span class="i-lucide:chevron-down w-3 h-3" aria-hidden="true" data-v-7c7ff4be></span></span> ${ssrInterpolate(_ctx.$t("package.skeleton.maintainers"))}</h2></div><ul class="ms-6 space-y-2 list-none my-1 px-1" data-v-7c7ff4be><li data-v-7c7ff4be>`);
	_push(ssrRenderComponent(_component_SkeletonInline, { class: "h-5 w-28" }, null, _parent));
	_push(`</li><li data-v-7c7ff4be>`);
	_push(ssrRenderComponent(_component_SkeletonInline, { class: "h-5 w-24" }, null, _parent));
	_push(`</li></ul></section></div></div></div><section class="area-readme min-w-0 scroll-mt-20" data-v-7c7ff4be><div class="flex flex-wrap items-center justify-between mb-3 px-1" data-v-7c7ff4be><h2 class="text-xs font-mono text-fg-subtle uppercase tracking-wider" data-v-7c7ff4be>${ssrInterpolate(_ctx.$t("package.readme.title"))}</h2></div><div class="space-y-4" data-v-7c7ff4be>`);
...
var _sfc_setup$27 = _sfc_main.setup;
...
var Skeleton_default = /* @__PURE__ */ Object.assign(_plugin_vue_export_helper_default(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-7c7ff4be"]]), { __name: "PackageSkeleton" });
//#endregion
//#region app/components/Package/ExternalLinks.vue?vue&type=script&setup=true&lang.ts
var ExternalLinks_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(`<ul${ssrRenderAttrs(mergeProps({ class: "flex flex-wrap items-center gap-x-3 gap-y-1.5 sm:gap-4 list-none m-0 p-0 mt-3 text-sm" }, _attrs))}>`);
			if (unref(repositoryUrl)) {
				...
				_push(ssrRenderComponent(_component_LinkBase, {
					...
					default: withCtx((_, _push, _parent, _scopeId) => {
						...
						else _push(`<span${_scopeId}>${ssrInterpolate(_ctx.$t("package.links.repo"))}</span>`);
						...
						])) : (openBlock(), createBlock("span", { key: 1 }, toDisplayString(_ctx.$t("package.links.repo")), 1))];
					}),
					_: 1
				}, _parent));
				_push(`</li>`);
			...
			if (unref(homepageUrl)) {
				...
				_push(ssrRenderComponent(_component_LinkBase, {
					...
					default: withCtx((_, _push, _parent, _scopeId) => {
						if (_push) _push(`${ssrInterpolate(_ctx.$t("package.links.homepage"))}`);
						else return [createTextVNode(toDisplayString(_ctx.$t("package.links.homepage")), 1)];
					}),
					_: 1
				}, _parent));
				_push(`</li>`);
			...
			if (unref(displayVersion)?.bugs?.url) {
				...
				_push(ssrRenderComponent(_component_LinkBase, {
					...
					default: withCtx((_, _push, _parent, _scopeId) => {
						if (_push) _push(`${ssrInterpolate(_ctx.$t("package.links.issues"))}`);
						else return [createTextVNode(toDisplayString(_ctx.$t("package.links.issues")), 1)];
					}),
					_: 1
				}, _parent));
				_push(`</li>`);
			...
			_push(`<li>`);
			_push(ssrRenderComponent(_component_LinkBase, {
				to: `https://www.npmjs.com/package/${__props.pkg.name}`,
				title: _ctx.$t("common.view_on.npm"),
			...
			_push(`</li>`);
			if (__props.jsrInfo?.exists && __props.jsrInfo.url) {
				_push(`<li>`);
				_push(ssrRenderComponent(_component_LinkBase, {
					to: __props.jsrInfo.url,
					title: _ctx.$t("badges.jsr.title"),
					classicon: "i-simple-icons:jsr"
				}, {
					default: withCtx((_, _push, _parent, _scopeId) => {
						if (_push) _push(`${ssrInterpolate(_ctx.$t("package.links.jsr"))}`);
						else return [createTextVNode(toDisplayString(_ctx.$t("package.links.jsr")), 1)];
					}),
					_: 1
				}, _parent));
				_push(`</li>`);
...
//#endregion
//#region app/components/Package/ExternalLinks.vue
var _sfc_setup$26 = ExternalLinks_vue_vue_type_script_setup_true_lang_default.setup;
ExternalLinks_vue_vue_type_script_setup_true_lang_default.setup = (props, ctx) => {
	const ssrContext = useSSRContext();
	(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Package/ExternalLinks.vue");
	return _sfc_setup$26 ? _sfc_setup$26(props, ctx) : void 0;
};
var ExternalLinks_default = Object.assign(ExternalLinks_vue_vue_type_script_setup_true_lang_default, { __name: "PackageExternalLinks" });
//#endregion
//#region app/composables/usePackageAnalysis.ts
/**
...
//#endregion
//#region app/components/Package/MetricsBadges.vue?vue&type=script&setup=true&lang.ts
var MetricsBadges_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			if (unref(isWasm) && !unref(isLoading)) {
				_push(`<li class="contents">`);
				_push(ssrRenderComponent(_component_TooltipApp, {
					text: unref($t)("package.metrics.wasm"),
					strategy: "fixed"
				}, {
					default: withCtx((_, _push, _parent, _scopeId) => {
						if (_push) _push(ssrRenderComponent(unref(Static_default), {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) _push(`WASM`);
								else return [createTextVNode("WASM")];
							}),
							_: 1
						}, _parent, _scopeId));
							...
							default: withCtx(() => [createTextVNode("WASM")]),
							_: 1
						})];
					}),
					_: 1
...
//#endregion
//#region app/components/Package/MetricsBadges.vue
var _sfc_setup$25 = MetricsBadges_vue_vue_type_script_setup_true_lang_default.setup;
...
//#endregion
//#region app/components/LicenseDisplay.vue?vue&type=script&setup=true&lang.ts
...
//#endregion
//#region app/components/LicenseDisplay.vue
var _sfc_setup$24 = LicenseDisplay_vue_vue_type_script_setup_true_lang_default.setup;
...
//#endregion
//#region app/components/Button/Group.vue?vue&type=script&setup=true&lang.ts
...
//#endregion
//#region app/components/Button/Group.vue
var _sfc_setup$23 = Group_vue_vue_type_script_setup_true_lang_default.setup;
...
//#endregion
//#region app/utils/install-command.ts
var packageManagers = [
	{
		id: "npm",
		label: "npm",
...
//#endregion
//#region app/composables/useSelectedPackageManager.ts
/**
...
*
*/
var useSelectedPackageManager = createSharedComposable(function useSelectedPackageManager() {
	return useLocalStorage("npmx-pm", "npm");
});
//#endregion
//#region app/components/Package/ManagerSelect.vue?vue&type=script&setup=true&lang.ts
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			ssrRenderTeleport(_push, (_push) => {
				if (unref(isOpen)) {
					_push(`<ul${ssrRenderAttr("id", listboxId)} role="listbox" data-testid="package-manager-dropdown"${ssrRenderAttr("aria-activedescendant", unref(highlightedIndex) >= 0 ? `${listboxId}-${("packageManagers" in _ctx ? _ctx.packageManagers : unref(packageManagers))[unref(highlightedIndex)]?.id}` : void 0)}${ssrRenderAttr("aria-label", _ctx.$t("package.get_started.pm_label"))} style="${ssrRenderStyle(getDropdownStyle())}" class="fixed bg-bg-subtle border border-border rounded-md shadow-lg z-50"><!--[-->`);
			...
			}, "body", !__props.teleport, _parent);
			_push(`<!--]-->`);
		};
	}
});
//#endregion
//#region app/components/Package/ManagerSelect.vue
var _sfc_setup$22 = ManagerSelect_vue_vue_type_script_setup_true_lang_default.setup;
...
//#endregion
//#region app/components/Terminal/Execute.vue?vue&type=script&setup=true&lang.ts
/**
...
//#endregion
//#region app/components/Terminal/Execute.vue
var _sfc_setup$21 = Execute_vue_vue_type_script_setup_true_lang_default.setup;
...
//#endregion
//#region app/components/Package/DownloadButton.vue?vue&type=script&setup=true&lang.ts
var DownloadButton_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		async function getDownloadUrl(tarballUrl) {
			try {
		...
		async function downloadPackage() {
			...
			downloadFileLink(downloadUrl ?? tarballUrl, `${props.packageName.replace(/\//g, "__")}-${props.version.version}.tgz`);
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(ssrRenderComponent(_component_TooltipApp, mergeProps({ text: _ctx.$t("package.download.tarball") }, _attrs), {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(ssrRenderComponent(_component_ButtonBase, mergeProps({ ref: "triggerRef" }, _ctx.$attrs, {
						type: "button",
						onClick: downloadPackage,
						disabled: unref(loading),
						class: "border-border-subtle bg-bg-subtle! text-xs text-fg-muted hover:enabled:text-fg hover:enabled:border-border-hover"
					}), {
						default: withCtx((_, _push, _parent, _scopeId) => {
							if (_push) _push(`<span aria-hidden="true" class="${ssrRenderClass([unref(loading) ? "i-lucide:loader-circle animate-spin" : "i-lucide:download", "size-[1em]"])}"${_scopeId}></span> ${ssrInterpolate(_ctx.$t("package.download.button"))}`);
							else return [createVNode("span", {
								class: ["size-[1em]", unref(loading) ? "i-lucide:loader-circle animate-spin" : "i-lucide:download"],
								"aria-hidden": "true"
							}, null, 2), createTextVNode(" " + toDisplayString(_ctx.$t("package.download.button")), 1)];
						}),
						_: 1
					}, _parent, _scopeId));
					else return [createVNode(_component_ButtonBase, mergeProps({ ref: "triggerRef" }, _ctx.$attrs, {
						type: "button",
						onClick: downloadPackage,
						disabled: unref(loading),
						class: "border-border-subtle bg-bg-subtle! text-xs text-fg-muted hover:enabled:text-fg hover:enabled:border-border-hover"
...
//#endregion
//#region app/components/Package/DownloadButton.vue
var _sfc_setup$20 = DownloadButton_vue_vue_type_script_setup_true_lang_default.setup;
DownloadButton_vue_vue_type_script_setup_true_lang_default.setup = (props, ctx) => {
	const ssrContext = useSSRContext();
	(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Package/DownloadButton.vue");
	return _sfc_setup$20 ? _sfc_setup$20(props, ctx) : void 0;
};
var DownloadButton_default = Object.assign(DownloadButton_vue_vue_type_script_setup_true_lang_default, { __name: "PackageDownloadButton" });
//#endregion
//#region app/composables/useInstallCommand.ts
/**
...
//#endregion
//#region app/utils/run-command.ts
/**
...
//#endregion
//#region app/components/Terminal/Install.vue?vue&type=script&setup=true&lang.ts
...
//#endregion
//#region app/components/Terminal/Install.vue
...
//#endregion
//#region app/components/Package/Replacement.vue?vue&type=script&setup=true&lang.ts
...
//#endregion
//#region app/components/Package/Replacement.vue
...
//#endregion
//#region app/components/Package/SizeIncrease.vue?vue&type=script&setup=true&lang.ts
...
//#endregion
//#region app/components/Package/SizeIncrease.vue
...
//#endregion
//#region app/components/Package/Sidebar.vue?vue&type=script&setup=true&lang.ts
var Sidebar_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		const stickyStyle = computed(() => direction.value === "up" ? { top: `${56 + packageHeaderHeight.value}px` } : { bottom: `32px` });
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<div${ssrRenderAttrs(mergeProps({
				...
				style: unref(style)
			}, _attrs))}><div class="sticky w-full group-data-[direction=up]:self-start group-data-[direction=up]:top-30 group-data-[direction=up]:xl:top-14 group-data-[direction=down]:self-end group-data-[direction=down]:bottom-8" style="${ssrRenderStyle(unref(stickyStyle))}">`);
...
//#endregion
//#region app/components/Package/Sidebar.vue
var _sfc_setup$16 = Sidebar_vue_vue_type_script_setup_true_lang_default.setup;
...
//#endregion
//#region app/components/Package/AccessControls.vue?vue&type=script&setup=true&lang.ts
...
//#endregion
//#region app/components/Package/AccessControls.vue
var _sfc_setup$15 = AccessControls_vue_vue_type_script_setup_true_lang_default.setup;
...
//#endregion
//#region app/components/CollapsibleSection.vue?vue&type=script&setup=true&lang.ts
...
:root[data-collapsed~='${props.id}'] section[data-anchor-id='${props.id}'] .collapsible-content {
  ...
  overflow: hidden;
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			}, _attrs))}><div class="flex items-center justify-between mb-3 ps-1">`);
			ssrRenderVNode(_push, createVNode(resolveDynamicComponent(__props.headingLevel), { class: ["group text-xs text-fg-subtle uppercase tracking-wider flex gap-2", __props.subtitle ? "items-start" : "items-center"] }, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						if (__props.subtitle) _push(`<span class="block text-2xs normal-case tracking-normal"${_scopeId}>${ssrInterpolate(__props.subtitle)}</span>`);
						else _push(`<!---->`);
						_push(`</span>`);
						...
						"aria-hidden": "true"
					}, null, 2))], 8, ["aria-expanded", "aria-label"]), createVNode("span", null, [createVNode(unref(Base_default), { to: `#${__props.id}` }, {
						default: withCtx(() => [createTextVNode(toDisplayString(__props.title), 1)]),
						_: 1
					}, 8, ["to"]), __props.subtitle ? (openBlock(), createBlock("span", {
						key: 0,
			...
			_push(`</div></div><div${ssrRenderAttr("id", contentId)} class="grid ms-6 ps-1 grid-rows-[1fr] transition-[grid-template-rows] duration-200 ease-in-out collapsible-content"${ssrIncludeBooleanAttr(!isOpen.value) ? " inert" : ""}><div class="min-h-0 min-w-0">`);
			ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
...
//#endregion
//#region app/components/CollapsibleSection.vue
var _sfc_setup$14 = CollapsibleSection_vue_vue_type_script_setup_true_lang_default.setup;
...
//#endregion
//#region app/components/Package/SkillsCard.vue?vue&type=script&setup=true&lang.ts
...
//#endregion
//#region app/components/Package/SkillsCard.vue
var _sfc_setup$13 = SkillsCard_vue_vue_type_script_setup_true_lang_default.setup;
...
//#endregion
//#region app/components/Package/ChartModal.vue?vue&type=script&setup=true&lang.ts
...
//#endregion
//#region app/components/Package/ChartModal.vue
var _sfc_setup$12 = ChartModal_vue_vue_type_script_setup_true_lang_default.setup;
...
//#endregion
//#region app/components/Package/WeeklyDownloadStats.vue?vue&type=script&setup=true&lang.ts
var easterEggResetDelay = 1500;
var WeeklyDownloadStats_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		const modalSubtitle = computed(() => {
			const facet = route.query.facet;
			if (facet === "likes" || facet === "contributors") return void 0;
		...
		function pushEasterEggKey(key) {
			clearTimeout(resetTimeout);
			resetTimeout = setTimeout(resetEasterEgg, easterEggResetDelay);
			const expectedKey = cheatCode[easterEgg.value.length];
		...
		function playEggPulse() {
			...
			(void 0).documentElement.offsetHeight;
			eggPulse.value = true;
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(ssrRenderComponent(_component_CollapsibleSection, {
				...
				actions: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) if (unref(hasWeeklyDownloads)) _push(ssrRenderComponent(_component_ButtonBase, {
						...
						default: withCtx((_, _push, _parent, _scopeId) => {
							if (_push) _push(`<span class="sr-only" data-v-3a86d671${_scopeId}>${ssrInterpolate(unref($t)("package.trends.title"))}</span>`);
							else return [createVNode("span", { class: "sr-only" }, toDisplayString(unref($t)("package.trends.title")), 1)];
						}),
						_: 1
					}, _parent, _scopeId));
					else if (unref(isLoadingWeeklyDownloads)) _push(`<span class="min-w-6 min-h-6 -m-1 p-1" data-v-3a86d671${_scopeId}></span>`);
					else _push(`<!---->`);
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<div class="${ssrRenderClass([{ "egg-pulse": unref(eggPulse) }, "w-full h-[76px] egg-pulse-target"])}" data-v-3a86d671${_scopeId}>`);
						if (unref(isLoadingWeeklyDownloads) || unref(hasWeeklyDownloads)) _push(ssrRenderComponent(_component_ClientOnly, null, { fallback: withCtx((_, _push, _parent, _scopeId) => {
							if (_push) {
								_push(`<div class="max-w-xs" data-v-3a86d671${_scopeId}><div class="h-6 flex items-center ps-3" data-v-3a86d671${_scopeId}>`);
								_push(ssrRenderComponent(_component_SkeletonInline, { class: "h-3 w-36" }, null, _parent, _scopeId));
								_push(`</div><div class="aspect-[500/80] flex items-center" data-v-3a86d671${_scopeId}><div class="w-[42%] flex items-center ps-0.5" data-v-3a86d671${_scopeId}>`);
								_push(ssrRenderComponent(_component_SkeletonInline, { class: "h-7 w-24" }, null, _parent, _scopeId));
								_push(`</div><div class="flex-1 flex items-end pe-3" data-v-3a86d671${_scopeId}>`);
						...
						else _push(`<p class="py-2 text-sm font-mono text-fg-subtle" data-v-3a86d671${_scopeId}>${ssrInterpolate(unref($t)("package.trends.no_data"))}</p>`);
						_push(`</div>`);
					} else return [createVNode("div", { class: ["w-full h-[76px] egg-pulse-target", { "egg-pulse": unref(eggPulse) }] }, [unref(isLoadingWeeklyDownloads) || unref(hasWeeklyDownloads) ? (openBlock(), createBlock(_component_ClientOnly, { key: 0 }, {
						...
						default: withCtx(() => [createVNode(unref(VueUiSparkline), {
							...
							hint: withCtx(({ isVisible }) => [isVisible ? (openBlock(), createBlock("p", {
								key: 0,
								class: "text-accent text-xs text-center mt-2",
								"aria-hidden": "true"
							}, toDisplayString(unref($t)("package.downloads.sparkline_nav_hint")), 1)) : createCommentVNode("", true)]),
					...
					}, toDisplayString(unref($t)("package.trends.no_data")), 1))], 2)];
				}),
				_: 1
			}, _parent));
			_push(`</div>`);
			if (unref(isChartModalOpen) && unref(hasWeeklyDownloads)) _push(ssrRenderComponent(_component_PackageChartModal, {
				...
				"modal-subtitle": unref(modalSubtitle),
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						if (!unref(hasChartModalTransitioned)) _push(`<div class="w-full aspect-[390/634.5] sm:aspect-[718/647]" data-v-3a86d671${_scopeId}></div>`);
						else _push(`<!---->`);
...
//#endregion
//#region app/components/Package/WeeklyDownloadStats.vue
var _sfc_setup$11 = WeeklyDownloadStats_vue_vue_type_script_setup_true_lang_default.setup;
...
var WeeklyDownloadStats_default = /* @__PURE__ */ Object.assign(_plugin_vue_export_helper_default(WeeklyDownloadStats_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-3a86d671"]]), { __name: "PackageWeeklyDownloadStats" });
//#endregion
//#region app/components/Package/Playgrounds.vue?vue&type=script&setup=true&lang.ts
var Playgrounds_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		function focusMenuItem(index) {
			(menuRef.value?.querySelectorAll("[role=\"menuitem\"]"))?.[index]?.focus();
		}
		return (_ctx, _push, _parent, _attrs) => {
			const _component_CollapsibleSection = CollapsibleSection_default;
			const _component_TooltipApp = App_default;
			if (__props.links.length > 0) _push(ssrRenderComponent(_component_CollapsibleSection, mergeProps({
				id: "playgrounds",
				title: _ctx.$t("package.playgrounds.title")
			}, _attrs), {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<div class="relative"${_scopeId}>`);
						...
						if (unref(hasMultipleLinks)) _push(`<button type="button" aria-haspopup="true"${ssrRenderAttr("aria-expanded", unref(isOpen))} class="w-full flex items-center justify-between gap-2 px-3 py-2 text-sm font-mono bg-bg-muted border border-border rounded-md hover:border-border-hover hover:bg-bg-elevated focus-visible:outline-accent/70 transition-colors duration-200"${_scopeId}><span class="flex items-center gap-2"${_scopeId}><span class="i-lucide:play w-4 h-4 shrink-0 text-fg-muted" aria-hidden="true"${_scopeId}></span><span class="text-fg-muted"${_scopeId}>${ssrInterpolate(_ctx.$t("package.playgrounds.choose"))} (${ssrInterpolate(__props.links.length)})</span></span><span class="${ssrRenderClass([{ "rotate-180": unref(isOpen) }, "i-lucide:chevron-down w-3 h-3 text-fg-subtle transition-transform duration-200 motion-reduce:transition-none"])}" aria-hidden="true"${_scopeId}></span></button>`);
						else _push(`<!---->`);
						if (unref(isOpen) && unref(hasMultipleLinks)) {
							_push(`<div role="menu" class="absolute top-full inset-is-0 inset-ie-0 mt-1 bg-bg-elevated border border-border rounded-lg shadow-lg z-50 py-1 overflow-visible"${_scopeId}><!--[-->`);
						...
						unref(hasSingleLink) && unref(firstLink) ? (openBlock(), createBlock(_component_TooltipApp, {
							key: 0,
							text: unref(firstLink).providerName,
							class: "w-full"
						}, {
						...
						unref(hasMultipleLinks) ? (openBlock(), createBlock("button", {
							key: 1,
							type: "button",
							"aria-haspopup": "true",
						...
						}, [createVNode("span", { class: "flex items-center gap-2" }, [createVNode("span", {
							class: "i-lucide:play w-4 h-4 shrink-0 text-fg-muted",
							"aria-hidden": "true"
						}), createVNode("span", { class: "text-fg-muted" }, toDisplayString(_ctx.$t("package.playgrounds.choose")) + " (" + toDisplayString(__props.links.length) + ")", 1)]), createVNode("span", {
							class: ["i-lucide:chevron-down w-3 h-3 text-fg-subtle transition-transform duration-200 motion-reduce:transition-none", { "rotate-180": unref(isOpen) }],
							"aria-hidden": "true"
						}, null, 2)], 40, ["aria-expanded", "onClick"])) : createCommentVNode("", true),
						createVNode(Transition, {
							...
							default: withCtx(() => [unref(isOpen) && unref(hasMultipleLinks) ? (openBlock(), createBlock("div", {
								key: 0,
								ref_key: "menuRef",
								ref: menuRef,
								role: "menu",
								...
								return openBlock(), createBlock(_component_TooltipApp, {
									key: link.url,
									text: link.providerName,
									class: "block"
								}, {
							...
							}), 128))], 544)) : createCommentVNode("", true)]),
							_: 1
						})
					], 512)];
				}),
...
//#endregion
//#region app/components/Package/Playgrounds.vue
var _sfc_setup$10 = Playgrounds_vue_vue_type_script_setup_true_lang_default.setup;
...
//#endregion
//#region app/components/Package/Compatibility.vue?vue&type=script&setup=true&lang.ts
...
//#endregion
//#region app/components/Package/Compatibility.vue
var _sfc_setup$9 = Compatibility_vue_vue_type_script_setup_true_lang_default.setup;
...
//#endregion
//#region app/composables/useVersionDistribution.ts
/**
...
function useVersionDistribution(packageName) {
	const groupingMode = useRouteQuery("grouping", "major", {
		transform: (v) => v === "minor" ? "minor" : "major",
		mode: "replace"
	});
...
function useBooleanRouteQuery(key, defaultValue = false) {
...
//#endregion
//#region app/components/Package/VersionDistribution.vue?vue&type=script&setup=true&lang.ts
...
var VersionDistribution_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		function buildExportFilename(extension) {
			...
			return `${sanitise(applyEllipsis(props.packageName, 32) ?? "")}_${range}.${extension}`;
		}
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			}, _attrs))} data-v-a304e7ac><div class="flex flex-col sm:flex-row gap-3 sm:gap-4 sm:items-end mb-6" data-v-a304e7ac><div class="flex flex-col gap-1" data-v-a304e7ac><label class="text-3xs font-mono text-fg-subtle tracking-wide uppercase" data-v-a304e7ac>${ssrInterpolate(unref($t)("package.versions.distribution_title"))}</label>`);
			...
			_push(`</div><div class="flex flex-col gap-1" data-v-a304e7ac><label class="text-3xs font-mono text-fg-subtle tracking-wide uppercase flex items-center gap-2" data-v-a304e7ac><span data-v-a304e7ac>${ssrInterpolate(unref($t)("package.versions.grouping_versions_title"))}</span>`);
			_push(ssrRenderComponent(App_default, {
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<span tabindex="0" class="i-lucide:info w-3.5 h-3.5 text-fg-subtle cursor-help shrink-0 rounded-sm" role="img"${ssrRenderAttr("aria-label", unref($t)("package.versions.grouping_versions_about"))} data-v-a304e7ac${_scopeId}></span>`);
					else return [createVNode("span", {
						tabindex: "0",
						class: "i-lucide:info w-3.5 h-3.5 text-fg-subtle cursor-help shrink-0 rounded-sm",
						role: "img",
						"aria-label": unref($t)("package.versions.grouping_versions_about")
					}, null, 8, ["aria-label"])];
				}),
				_: 1
			}, _parent));
			...
			_push(`</div><div class="flex flex-col gap-1" data-v-a304e7ac><label class="text-3xs font-mono text-fg-subtle tracking-wide uppercase flex items-center gap-2" data-v-a304e7ac><span data-v-a304e7ac>${ssrInterpolate(unref($t)("package.versions.grouping_usage_title"))}</span>`);
			_push(ssrRenderComponent(App_default, {
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<span tabindex="0" class="i-lucide:info w-3.5 h-3.5 text-fg-subtle cursor-help shrink-0 rounded-sm" role="img"${ssrRenderAttr("aria-label", unref($t)("package.versions.grouping_usage_about"))} data-v-a304e7ac${_scopeId}></span>`);
					else return [createVNode("span", {
						tabindex: "0",
						class: "i-lucide:info w-3.5 h-3.5 text-fg-subtle cursor-help shrink-0 rounded-sm",
						role: "img",
						"aria-label": unref($t)("package.versions.grouping_usage_about")
					}, null, 8, ["aria-label"])];
				}),
				_: 1
			}, _parent));
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(ssrRenderComponent(_component_ButtonBase, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) _push(`${ssrInterpolate(unref($t)("package.versions.grouping_usage_most_used"))}`);
								else return [createTextVNode(toDisplayString(unref($t)("package.versions.grouping_usage_most_used")), 1)];
							}),
							_: 1
						}, _parent, _scopeId));
						_push(ssrRenderComponent(_component_ButtonBase, {
						...
						default: withCtx(() => [createTextVNode(toDisplayString(unref($t)("package.versions.grouping_usage_most_used")), 1)]),
						_: 1
					}, 8, ["onClick", "variant"]), createVNode(_component_ButtonBase, {
						onClick: ($event) => showLowUsageVersions.value = true,
						variant: unref(showLowUsageVersions) ? "primary" : "secondary"
			...
			_push(`</div></div><h2 id="version-distribution-title" class="sr-only" data-v-a304e7ac>${ssrInterpolate(unref($t)("package.versions.distribution_title"))}</h2><div role="region" aria-labelledby="version-distribution-title" class="${ssrRenderClass([unref(isMobile) ? "min-h-[260px]" : "min-h-[520px]", "relative"])}" data-v-a304e7ac>`);
			if (unref(xyDataset).length > 0 && !unref(error)) _push(ssrRenderComponent(_component_ClientOnly, null, { fallback: withCtx((_, _push, _parent, _scopeId) => {
				if (_push) _push(`<div data-v-a304e7ac${_scopeId}></div>`);
				else return [createVNode("div")];
			}) }, _parent));
			else _push(`<!---->`);
			if (!unref(hasData) && !unref(pending) && !unref(error)) _push(`<div class="flex items-center justify-center h-full" data-v-a304e7ac><div class="text-sm text-fg-subtle font-mono text-center flex flex-col items-center gap-2" data-v-a304e7ac><span class="i-lucide:database w-8 h-8" data-v-a304e7ac></span><p data-v-a304e7ac>${ssrInterpolate(unref($t)("package.trends.no_data"))}</p></div></div>`);
			else _push(`<!---->`);
			if (unref(error)) _push(`<div class="flex items-center justify-center h-full" role="alert" data-v-a304e7ac><div class="text-sm text-fg-subtle font-mono text-center flex flex-col items-center gap-2" data-v-a304e7ac><span class="i-lucide:octagon-alert w-8 h-8 text-red-400" data-v-a304e7ac></span><p data-v-a304e7ac>${ssrInterpolate(unref(error).message)}</p><p class="text-xs" data-v-a304e7ac>Package: ${ssrInterpolate(__props.packageName)}</p></div></div>`);
			else _push(`<!---->`);
			if (unref(showLoadingIndicator)) _push(`<div role="status" aria-live="polite" class="absolute top-1/2 inset-is-1/2 -translate-x-1/2 -translate-y-1/2" data-v-a304e7ac><div class="text-xs text-fg-subtle font-mono bg-bg/70 backdrop-blur px-3 py-2 rounded-md border border-border" data-v-a304e7ac>${ssrInterpolate(unref($t)("common.loading"))}</div></div>`);
			else _push(`<!---->`);
			_push(`</div></div>`);
		};
	}
...
//#endregion
//#region app/components/Package/VersionDistribution.vue
var _sfc_setup$8 = VersionDistribution_vue_vue_type_script_setup_true_lang_default.setup;
...
var VersionDistribution_default = /* @__PURE__ */ Object.assign(_plugin_vue_export_helper_default(VersionDistribution_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-a304e7ac"]]), { __name: "PackageVersionDistribution" });
//#endregion
//#region app/components/Package/Versions.vue?vue&type=script&setup=true&lang.ts
...
var Versions_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		const versionsPageRoute = computed(() => {
			const [org, name = ""] = props.packageName.startsWith("@") ? props.packageName.split("/") : ["", props.packageName];
			return {
		...
		const visibleTagRows = computed(() => {
			...
			const rows = isFilterActive.value ? rowsMaybeFilteredForDeprecation.filter((row) => filteredVersionSet.value.has(row.primaryVersion.version) || getTagVersions(row.tag).some((v) => filteredVersionSet.value.has(v.version))) : rowsMaybeFilteredForDeprecation;
		...
		const hiddenTagRows = computed(() => {
			...
			return isFilterActive.value ? hiddenRows.filter((row) => filteredVersionSet.value.has(row.primaryVersion.version) || getTagVersions(row.tag).some((v) => filteredVersionSet.value.has(v.version))) : hiddenRows;
		});
		...
		function getExpandedTagVersions(tag, primaryVersion) {
		...
		function isTagExpanded(tag, primaryVersion) {
			return expandedTags.value.has(tag) || isFilterActive.value && getExpandedTagVersions(tag, primaryVersion).length > 0;
		}
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			if (unref(allTagRows).length > 0) _push(ssrRenderComponent(_component_CollapsibleSection, {
				...
				actions: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<div class="flex items-center gap-3" data-v-e79caaa7${_scopeId}>`);
						_push(ssrRenderComponent(_component_LinkBase, {
							to: unref(versionsPageRoute),
							variant: "button-secondary",
							class: "text-fg-subtle hover:text-fg transition-colors min-w-6 min-h-6 p-1 rounded",
							title: _ctx.$t("package.versions.view_all_versions"),
							classicon: "i-lucide:history",
							"data-testid": "view-all-versions-link"
						}, {
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) _push(`<span class="sr-only" data-v-e79caaa7${_scopeId}>${ssrInterpolate(_ctx.$t("package.versions.view_all_versions"))}</span>`);
								else return [createVNode("span", { class: "sr-only" }, toDisplayString(_ctx.$t("package.versions.view_all_versions")), 1)];
							}),
							_: 1
						}, _parent, _scopeId));
						_push(ssrRenderComponent(_component_ButtonBase, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) _push(`<span class="sr-only" data-v-e79caaa7${_scopeId}>${ssrInterpolate(_ctx.$t("package.downloads.community_distribution"))}</span>`);
								else return [createVNode("span", { class: "sr-only" }, toDisplayString(_ctx.$t("package.downloads.community_distribution")), 1)];
							}),
							_: 1
						}, _parent, _scopeId));
						_push(`</div>`);
					} else return [createVNode("div", { class: "flex items-center gap-3" }, [createVNode(_component_LinkBase, {
						to: unref(versionsPageRoute),
						variant: "button-secondary",
						class: "text-fg-subtle hover:text-fg transition-colors min-w-6 min-h-6 p-1 rounded",
						title: _ctx.$t("package.versions.view_all_versions"),
						...
						default: withCtx(() => [createVNode("span", { class: "sr-only" }, toDisplayString(_ctx.$t("package.versions.view_all_versions")), 1)]),
						_: 1
					}, 8, ["to", "title"]), createVNode(_component_ButtonBase, {
						variant: "secondary",
						class: "text-fg-subtle hover:text-fg transition-colors min-w-6 min-h-6 -m-1 p-1 rounded",
						title: _ctx.$t("package.downloads.community_distribution"),
						classicon: "i-lucide:file-stack",
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<div class="space-y-0.5 min-w-0" data-v-e79caaa7${_scopeId}><div data-v-e79caaa7${_scopeId}><div class="flex items-center gap-2 pb-1 pe-1" data-v-e79caaa7${_scopeId}>`);
						...
						_push(ssrRenderComponent(_component_TooltipApp, {
							...
							content: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) {
									_push(`<p class="text-xs text-fg-muted" data-v-e79caaa7${_scopeId}>`);
									_push(ssrRenderComponent(_component_i18n_t, {
										keypath: "package.versions.filter_tooltip",
										tag: "span"
									}, {
										link: withCtx((_, _push, _parent, _scopeId) => {
											if (_push) _push(ssrRenderComponent(_component_LinkBase, { to: `${"NPMX_DOCS_SITE" in _ctx ? _ctx.NPMX_DOCS_SITE : unref(NPMX_DOCS_SITE)}/guide/semver-ranges` }, {
												default: withCtx((_, _push, _parent, _scopeId) => {
											...
											else return [createVNode(_component_LinkBase, { to: `${"NPMX_DOCS_SITE" in _ctx ? _ctx.NPMX_DOCS_SITE : unref(NPMX_DOCS_SITE)}/guide/semver-ranges` }, {
									...
									link: withCtx(() => [createVNode(_component_LinkBase, { to: `${"NPMX_DOCS_SITE" in _ctx ? _ctx.NPMX_DOCS_SITE : unref(NPMX_DOCS_SITE)}/guide/semver-ranges` }, {
										default: withCtx(() => [createTextVNode(toDisplayString(_ctx.$t("package.versions.filter_tooltip_link")), 1)]),
										_: 1
									}, 8, ["to"])]),
									_: 1
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) _push(`<span tabindex="0" class="block cursor-help shrink-0 -m-2 p-2 -me-1 focus-visible:outline-2 focus-visible:outline-accent/70 rounded" data-v-e79caaa7${_scopeId}><span class="block i-lucide:info w-3.5 h-3.5 text-fg-subtle" role="img"${ssrRenderAttr("aria-label", _ctx.$t("package.versions.filter_help"))} data-v-e79caaa7${_scopeId}></span></span>`);
								else return [createVNode("span", {
									tabindex: "0",
						...
						_push(`</div>`);
						if (unref(isInvalidRange)) _push(`<p id="semver-filter-error" class="text-red-500 text-3xs mt-1" role="alert" data-v-e79caaa7${_scopeId}>${ssrInterpolate(_ctx.$t("package.versions.filter_invalid"))}</p>`);
						else _push(`<!---->`);
						_push(`</div>`);
						if (unref(hasNoFilterMatches)) _push(`<div class="px-1 py-2 text-xs text-fg-subtle" role="status" aria-live="polite" data-v-e79caaa7${_scopeId}>${ssrInterpolate(_ctx.$t("package.versions.no_matches"))}</div>`);
						else _push(`<!---->`);
						_push(`<!--[-->`);
						ssrRenderList(unref(visibleTagRows), (row) => {
							_push(`<div data-v-e79caaa7${_scopeId}><div class="${ssrRenderClass([rowContainsCurrentVersion(row) ? "bg-bg-subtle" : "", "flex items-center gap-2 pe-2 px-1 relative group/version-row hover:bg-bg-subtle focus-within:bg-bg-subtle transition-colors duration-200 rounded-lg"])}" data-v-e79caaa7${_scopeId}>`);
							if (getTagVersions(row.tag).length > 1 || !unref(hasLoadedAll)) {
								_push(`<button type="button" class="size-5 -me-1 flex items-center justify-center text-fg-subtle hover:text-fg transition-colors rounded-sm relative z-10"${ssrRenderAttr("aria-expanded", isTagExpanded(row.tag, row.primaryVersion.version))}${ssrRenderAttr("aria-label", unref(expandedTags).has(row.tag) ? _ctx.$t("package.versions.collapse", { tag: row.tag }) : _ctx.$t("package.versions.expand", { tag: row.tag }))} data-testid="tag-expand-button" data-v-e79caaa7${_scopeId}>`);
								if (unref(loadingTags).has(row.tag)) _push(`<span class="i-svg-spinners:ring-resize w-3 h-3" data-testid="loading-spinner" aria-hidden="true" data-v-e79caaa7${_scopeId}></span>`);
								else _push(`<span class="${ssrRenderClass([isTagExpanded(row.tag, row.primaryVersion.version) ? "i-lucide:chevron-down" : "i-lucide:chevron-right", "size-3 transition-transform duration-200 rtl-flip"])}" aria-hidden="true" data-v-e79caaa7${_scopeId}></span>`);
								_push(`</button>`);
							} else _push(`<span class="w-5" data-v-e79caaa7${_scopeId}></span>`);
							_push(`<div class="flex-1 py-1.5 min-w-0 flex gap-2 justify-between items-center" data-v-e79caaa7${_scopeId}><div class="overflow-hidden" data-v-e79caaa7${_scopeId}>`);
							_push(ssrRenderComponent(_component_LinkBase, {
								...
								default: withCtx((_, _push, _parent, _scopeId) => {
									if (_push) _push(`<span dir="ltr" class="block truncate" data-v-e79caaa7${_scopeId}>${ssrInterpolate(row.primaryVersion.version)}</span>`);
									else return [createVNode("span", {
										dir: "ltr",
							...
							if (row.tags.length) {
								_push(`<div class="flex items-center gap-1 mt-0.5 flex-wrap relative z-10" data-v-e79caaa7${_scopeId}><!--[-->`);
								ssrRenderList(row.tags, (tag) => {
									_push(`<span class="${ssrRenderClass([tag === "latest" ? "text-accent" : "text-fg-subtle", "text-4xs font-semibold uppercase tracking-wide truncate"])}"${ssrRenderAttr("title", tag)} data-v-e79caaa7${_scopeId}>${ssrInterpolate(tag)}</span>`);
								});
								_push(`<!--]--></div>`);
							} else _push(`<!---->`);
							_push(`</div><div class="flex items-center gap-2 shrink-0 relative z-10" data-v-e79caaa7${_scopeId}>`);
							...
							_push(`</div></div></div>`);
							if (isTagExpanded(row.tag, row.primaryVersion.version)) {
								_push(`<div class="ms-4 ps-2 border-is border-border space-y-0.5 pe-2" data-v-e79caaa7${_scopeId}><!--[-->`);
								ssrRenderList(getExpandedTagVersions(row.tag, row.primaryVersion.version), (v) => {
									_push(`<div class="${ssrRenderClass([v.version === unref(effectiveCurrentVersion) ? "bg-bg-elevated/20 rounded" : "", "py-1 relative group/version-row hover:bg-bg-elevated/20 focus-within:bg-bg-elevated/20 transition-colors duration-200"])}" data-v-e79caaa7${_scopeId}><div class="flex items-center justify-between gap-2" data-v-e79caaa7${_scopeId}>`);
									_push(ssrRenderComponent(_component_LinkBase, {
										...
										default: withCtx((_, _push, _parent, _scopeId) => {
											if (_push) _push(`<span dir="ltr" class="block truncate" data-v-e79caaa7${_scopeId}>${ssrInterpolate(v.version)}</span>`);
											else return [createVNode("span", {
												dir: "ltr",
												class: "block truncate"
									...
									_push(`<div class="flex items-center gap-2 shrink-0 relative z-10" data-v-e79caaa7${_scopeId}>`);
									...
									_push(`</div></div>`);
									if (v.tags?.length && ("filterExcludedTags" in _ctx ? _ctx.filterExcludedTags : unref(filterExcludedTags))(v.tags, row.tags).length) {
										_push(`<div class="flex items-center gap-1 mt-0.5 relative z-10" data-v-e79caaa7${_scopeId}><!--[-->`);
										ssrRenderList(("filterExcludedTags" in _ctx ? _ctx.filterExcludedTags : unref(filterExcludedTags))(v.tags, row.tags), (tag) => {
											_push(`<span class="${ssrRenderClass([tag === "latest" ? "text-accent" : "text-fg-subtle", "text-5xs font-semibold uppercase tracking-wide truncate max-w-[120px]"])}"${ssrRenderAttr("title", tag)} data-v-e79caaa7${_scopeId}>${ssrInterpolate(tag)}</span>`);
										});
										_push(`<!--]--></div>`);
									} else _push(`<!---->`);
									_push(`</div>`);
						...
						_push(`<!--]--><div class="p-1" data-v-e79caaa7${_scopeId}><button type="button" class="${ssrRenderClass([otherVersionsContainsCurrent() ? "bg-bg-subtle" : "", "flex items-center gap-2 text-start rounded-sm w-full"])}"${ssrRenderAttr("aria-expanded", unref(otherVersionsExpanded))}${ssrRenderAttr("aria-label", unref(otherVersionsExpanded) ? _ctx.$t("package.versions.collapse_other") : _ctx.$t("package.versions.expand_other"))} data-v-e79caaa7${_scopeId}><span class="size-5 -me-1 flex items-center justify-center text-fg-subtle hover:text-fg transition-colors" data-v-e79caaa7${_scopeId}>`);
						if (unref(otherVersionsLoading)) _push(`<span class="i-svg-spinners:ring-resize w-3 h-3" data-testid="loading-spinner" aria-hidden="true" data-v-e79caaa7${_scopeId}></span>`);
						else _push(`<span class="${ssrRenderClass([unref(otherVersionsExpanded) ? "i-lucide:chevron-down" : "i-lucide:chevron-right", "w-3 h-3 transition-transform duration-200 rtl-flip"])}" aria-hidden="true" data-v-e79caaa7${_scopeId}></span>`);
						_push(`</span><span class="text-xs text-fg-muted py-1.5" data-v-e79caaa7${_scopeId}>${ssrInterpolate(_ctx.$t("package.versions.other_versions"))} `);
						if (unref(hiddenTagRows).length > 0) _push(`<span class="text-fg-subtle" data-v-e79caaa7${_scopeId}> (${ssrInterpolate(_ctx.$t("package.versions.more_tagged", { count: unref(hiddenTagRows).length }, unref(hiddenTagRows).length))}) </span>`);
						else _push(`<!---->`);
						_push(`</span></button>`);
						if (unref(otherVersionsExpanded)) {
							_push(`<div class="ms-4 ps-2 border-is border-border space-y-0.5" data-v-e79caaa7${_scopeId}><!--[-->`);
							ssrRenderList(unref(hiddenTagRows), (row) => {
								_push(`<div class="${ssrRenderClass([hiddenRowContainsCurrent(row) ? "bg-bg-subtle" : "", "py-1 relative group/version-row hover:bg-bg-subtle focus-within:bg-bg-subtle transition-colors duration-200 rounded-lg"])}" data-v-e79caaa7${_scopeId}><div class="flex items-center justify-between gap-2" data-v-e79caaa7${_scopeId}>`);
								_push(ssrRenderComponent(_component_LinkBase, {
									to: versionRoute(row.primaryVersion.version),
									block: "",
								...
								_push(`<div class="flex items-center gap-2 shrink-0 pe-2 relative z-10" data-v-e79caaa7${_scopeId}>`);
								if (row.primaryVersion.time) _push(ssrRenderComponent(_component_DateTime, {
									datetime: row.primaryVersion.time,
									class: "text-3xs text-fg-subtle",
									year: "numeric",
							...
							if (unref(filteredOtherMajorGroups).length > 0) {
								...
								ssrRenderList(unref(filteredOtherMajorGroups), (group) => {
									_push(`<div data-v-e79caaa7${_scopeId}>`);
									if (group.versions.length > 1) {
										_push(`<div class="${ssrRenderClass([majorGroupContainsCurrent(group) ? "bg-bg-subtle" : "", "py-1 relative group/version-row hover:bg-bg-subtle focus-within:bg-bg-subtle transition-colors duration-200 rounded-lg"])}" data-v-e79caaa7${_scopeId}><div class="flex items-center justify-between gap-2" data-v-e79caaa7${_scopeId}><div class="flex items-center gap-2 min-w-0" data-v-e79caaa7${_scopeId}><button type="button" class="w-4 h-4 flex items-center justify-center text-fg-subtle hover:text-fg transition-colors shrink-0 rounded-sm relative z-10"${ssrRenderAttr("aria-expanded", unref(expandedMajorGroups).has(group.groupKey))}${ssrRenderAttr("aria-label", unref(expandedMajorGroups).has(group.groupKey) ? _ctx.$t("package.versions.collapse_major", { major: group.label }) : _ctx.$t("package.versions.expand_major", { major: group.label }))} data-testid="major-group-expand-button" data-v-e79caaa7${_scopeId}><span class="${ssrRenderClass([unref(expandedMajorGroups).has(group.groupKey) ? "i-lucide:chevron-down" : "i-lucide:chevron-right", "w-3 h-3 transition-transform duration-200 rtl-flip"])}" aria-hidden="true" data-v-e79caaa7${_scopeId}></span></button>`);
										if (group.versions[0]?.version) _push(ssrRenderComponent(_component_LinkBase, {
											...
											default: withCtx((_, _push, _parent, _scopeId) => {
												if (_push) _push(`<span dir="ltr" class="block truncate" data-v-e79caaa7${_scopeId}>${ssrInterpolate(group.versions[0]?.version)}</span>`);
												else return [createVNode("span", {
													dir: "ltr",
													class: "block truncate"
										...
										_push(`</div><div class="flex items-center gap-2 shrink-0 pe-2 relative z-10" data-v-e79caaa7${_scopeId}>`);
										...
										if (group.versions[0]?.tags?.length) {
											_push(`<div class="flex items-center gap-1 ms-5 flex-wrap relative z-10" data-v-e79caaa7${_scopeId}><!--[-->`);
										...
										_push(`<div class="${ssrRenderClass([majorGroupContainsCurrent(group) ? "bg-bg-subtle" : "", "py-1 relative group/version-row hover:bg-bg-subtle focus-within:bg-bg-subtle transition-colors duration-200 rounded-lg"])}" data-v-e79caaa7${_scopeId}><div class="flex items-center justify-between gap-2" data-v-e79caaa7${_scopeId}><div class="flex items-center gap-2 min-w-0" data-v-e79caaa7${_scopeId}>`);
										if (group.versions[0]?.version) _push(ssrRenderComponent(_component_LinkBase, {
											to: versionRoute(group.versions[0]?.version),
											block: "",
										...
										_push(`</div></div>`);
										if (group.versions[0]?.tags?.length) {
											_push(`<div class="flex items-center gap-1 ms-5 relative z-10" data-v-e79caaa7${_scopeId}><!--[-->`);
											ssrRenderList(group.versions[0].tags, (tag) => {
												_push(`<span class="${ssrRenderClass([tag === "latest" ? "text-accent" : "text-fg-subtle", "text-5xs font-semibold uppercase tracking-wide"])}" data-v-e79caaa7${_scopeId}>${ssrInterpolate(tag)}</span>`);
											});
											_push(`<!--]--></div>`);
										} else _push(`<!---->`);
										_push(`</div>`);
									...
									if (unref(expandedMajorGroups).has(group.groupKey) && group.versions.length > 1) {
										_push(`<div class="ms-6 space-y-0.5" data-v-e79caaa7${_scopeId}><!--[-->`);
								...
								_push(`<!--]-->`);
							} else if (unref(hasLoadedAll) && unref(hiddenTagRows).length === 0) _push(`<div class="py-1 text-xs text-fg-subtle" data-v-e79caaa7${_scopeId}>${ssrInterpolate(_ctx.$t("package.versions.all_covered"))}</div>`);
							else _push(`<!---->`);
							_push(`</div>`);
						} else _push(`<!---->`);
						_push(`</div></div>`);
					} else return [createVNode("div", { class: "space-y-0.5 min-w-0" }, [
						createVNode("div", null, [createVNode("div", { class: "flex items-center gap-2 pb-1 pe-1" }, [createVNode(_component_InputBase, {
							modelValue: unref(semverFilter),
							"onUpdate:modelValue": ($event) => isRef(semverFilter) ? semverFilter.value = $event : null,
							type: "text",
							placeholder: _ctx.$t("package.versions.filter_placeholder"),
						...
						(openBlock(true), createBlock(Fragment, null, renderList(unref(visibleTagRows), (row) => {
							return openBlock(), createBlock("div", { key: row.id }, [createVNode("div", { class: ["flex items-center gap-2 pe-2 px-1 relative group/version-row hover:bg-bg-subtle focus-within:bg-bg-subtle transition-colors duration-200 rounded-lg", rowContainsCurrentVersion(row) ? "bg-bg-subtle" : ""] }, [getTagVersions(row.tag).length > 1 || !unref(hasLoadedAll) ? (openBlock(), createBlock("button", {
								...
								key: 1,
								class: ["size-3 transition-transform duration-200 rtl-flip", isTagExpanded(row.tag, row.primaryVersion.version) ? "i-lucide:chevron-down" : "i-lucide:chevron-right"],
								"aria-hidden": "true"
							}, null, 2))], 8, [
								"aria-expanded",
								"aria-label",
								...
								compact: "",
								linked: false
							}, null, 8, ["package-name", "version"])) : createCommentVNode("", true)])])], 2), isTagExpanded(row.tag, row.primaryVersion.version) ? (openBlock(), createBlock("div", {
								key: 0,
								class: "ms-4 ps-2 border-is border-border space-y-0.5 pe-2"
							}, [(openBlock(true), createBlock(Fragment, null, renderList(getExpandedTagVersions(row.tag, row.primaryVersion.version), (v) => {
								return openBlock(), createBlock("div", {
									key: v.version,
									...
									compact: "",
									linked: false
								}, null, 8, ["package-name", "version"])) : createCommentVNode("", true)])]), v.tags?.length && ("filterExcludedTags" in _ctx ? _ctx.filterExcludedTags : unref(filterExcludedTags))(v.tags, row.tags).length ? (openBlock(), createBlock("div", {
									key: 0,
									class: "flex items-center gap-1 mt-0.5 relative z-10"
								}, [(openBlock(true), createBlock(Fragment, null, renderList(("filterExcludedTags" in _ctx ? _ctx.filterExcludedTags : unref(filterExcludedTags))(v.tags, row.tags), (tag) => {
									return openBlock(), createBlock("span", {
										key: tag,
			...
			if (unref(isDistributionModalOpen)) _push(ssrRenderComponent(_component_PackageChartModal, {
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						if (!unref(hasDistributionModalTransitioned)) _push(`<div class="w-full aspect-[272/609] sm:aspect-[718/592.67]" data-v-e79caaa7${_scopeId}></div>`);
						else _push(`<!---->`);
					} else return [createVNode(Transition, {
						name: "opacity",
						mode: "out-in"
...
//#endregion
//#region app/components/Package/Versions.vue
var _sfc_setup$7 = Versions_vue_vue_type_script_setup_true_lang_default.setup;
...
var Versions_default = /* @__PURE__ */ Object.assign(_plugin_vue_export_helper_default(Versions_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-e79caaa7"]]), { __name: "PackageVersions" });
//#endregion
//#region app/utils/npm/outdated-dependencies.ts
/**
...
//#endregion
//#region app/composables/npm/useOutdatedDependencies.ts
var BATCH_SIZE = 50;
...
//#endregion
//#region app/components/Package/InstallScripts.vue?vue&type=script&setup=true&lang.ts
...
//#endregion
//#region app/components/Package/InstallScripts.vue
var _sfc_setup$6 = InstallScripts_vue_vue_type_script_setup_true_lang_default.setup;
...
//#endregion
//#region app/composables/npm/useReplacementDependencies.ts
/**
...
//#endregion
//#region app/composables/useDependencyAnalysis.ts
/**
...
//#endregion
//#region app/components/Package/Dependencies.vue?vue&type=script&setup=true&lang.ts
					...
					if (_push) {
						...
						ssrRenderList(unref(sortedDependencies).slice(0, unref(depsExpanded) ? void 0 : 10), ([dep, version]) => {
							...
							if (unref(outdatedDeps)[dep]) _push(ssrRenderComponent(_component_TooltipApp, {
								...
								default: withCtx((_, _push, _parent, _scopeId) => {
									if (_push) _push(`<button type="button" class="inline-flex items-center justify-center p-2 -m-2"${ssrRenderAttr("aria-label", unref(getOutdatedTooltip)(unref(outdatedDeps)[dep], _ctx.$t))}${_scopeId}><span class="i-lucide:circle-alert w-3 h-3" aria-hidden="true"${_scopeId}></span></button>`);
									else return [createVNode("button", {
										type: "button",
							...
							if (unref(replacementDeps)[dep]) _push(ssrRenderComponent(_component_TooltipApp, {
								...
								default: withCtx((_, _push, _parent, _scopeId) => {
									if (_push) _push(`<button type="button" class="inline-flex items-center justify-center p-2 -m-2"${ssrRenderAttr("aria-label", _ctx.$t("package.dependencies.has_replacement"))}${_scopeId}><span class="i-lucide:lightbulb w-3 h-3" aria-hidden="true"${_scopeId}></span></button>`);
									else return [createVNode("button", {
										type: "button",
										class: "inline-flex items-center justify-center p-2 -m-2",
							...
							if (getVulnerableDepInfo(dep)) _push(ssrRenderComponent(_component_LinkBase, {
								...
								title: _ctx.$t("package.dependencies.vulnerabilities_count", { count: getVulnerableDepInfo(dep).counts.total }),
							...
							if (getVulnerableDepInfo(dep)) _push(`<span class="sr-only"${_scopeId}> (${ssrInterpolate(_ctx.$t("package.dependencies.vulnerabilities_count", { count: getVulnerableDepInfo(dep).counts.total }))}) </span>`);
							else _push(`<!---->`);
							_push(`</span></li>`);
						});
						_push(`<!--]--></ul>`);
						...
						return openBlock(), createBlock("li", {
							...
							getVulnerableDepInfo(dep) ? (openBlock(), createBlock("span", {
								key: 5,
								class: "sr-only"
							}, " (" + toDisplayString(_ctx.$t("package.dependencies.vulnerabilities_count", { count: getVulnerableDepInfo(dep).counts.total })) + ") ", 1)) : createCommentVNode("", true)
						])]);
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						ssrRenderList(unref(sortedPeerDependencies).slice(0, unref(peerDepsExpanded) ? void 0 : 10), (peer) => {
							_push(`<li class="flex items-center justify-between py-1 text-sm gap-1 min-w-0"${_scopeId}><div class="flex items-center gap-2 min-w-0 flex-1"${_scopeId}>`);
							_push(ssrRenderComponent(_component_LinkBase, {
						...
						}, [createVNode("div", { class: "flex items-center gap-2 min-w-0 flex-1" }, [createVNode(_component_LinkBase, {
							to: ("packageRoute" in _ctx ? _ctx.packageRoute : unref(packageRoute))(peer.name),
							class: "block max-w-[70%] break-words",
							dir: "ltr"
						}, {
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						ssrRenderList(unref(sortedOptionalDependencies).slice(0, unref(optionalDepsExpanded) ? void 0 : 10), ([dep, version]) => {
							_push(`<li class="flex items-baseline justify-between py-1 text-sm gap-2"${_scopeId}>`);
							_push(ssrRenderComponent(_component_LinkBase, {
								to: ("packageRoute" in _ctx ? _ctx.packageRoute : unref(packageRoute))(dep),
...
//#endregion
//#region app/components/Package/Dependencies.vue
var _sfc_setup$5 = Dependencies_vue_vue_type_script_setup_true_lang_default.setup;
...
//#endregion
//#region app/components/Package/Keywords.vue?vue&type=script&setup=true&lang.ts
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			if (__props.keywords?.length) _push(ssrRenderComponent(_component_CollapsibleSection, mergeProps({
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<ul class="flex flex-wrap gap-1.5 list-none m-0 p-0"${_scopeId}><!--[-->`);
						...
						_push(`<!--]--></ul>`);
					} else return [createVNode("ul", { class: "flex flex-wrap gap-1.5 list-none m-0 p-0" }, [(openBlock(true), createBlock(Fragment, null, renderList(__props.keywords.slice(0, 15), (keyword) => {
...
//#endregion
//#region app/components/Package/Keywords.vue
var _sfc_setup$4 = Keywords_vue_vue_type_script_setup_true_lang_default.setup;
...
//#endregion
//#region app/components/Package/Maintainers.vue?vue&type=script&setup=true&lang.ts
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			if (__props.maintainers?.length) _push(ssrRenderComponent(_component_CollapsibleSection, mergeProps({
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<ul class="space-y-2 list-none m-0 p-0"${ssrRenderAttr("aria-label", _ctx.$t("package.maintainers.list_label"))}${_scopeId}><!--[-->`);
						ssrRenderList(unref(visibleMaintainers), (maintainer) => {
							...
							if (maintainer.name) _push(ssrRenderComponent(_component_LinkBase, {
								...
								default: withCtx((_, _push, _parent, _scopeId) => {
									if (_push) _push(ssrRenderComponent(_component_i18n_t, { keypath: "package.maintainers.maintainer_template" }, {
										avatar: withCtx((_, _push, _parent, _scopeId) => {
											if (_push) _push(ssrRenderComponent(_component_UserAvatar, {
												username: maintainer.name,
												size: "xs",
												"aria-hidden": "true"
											}, null, _parent, _scopeId));
											else return [createVNode(_component_UserAvatar, {
												username: maintainer.name,
												size: "xs",
												"aria-hidden": "true"
											}, null, 8, ["username"])];
										}),
										char126: withCtx((_, _push, _parent, _scopeId) => {
											if (_push) _push(`~`);
											else return [createTextVNode("~")];
										}),
										name: withCtx((_, _push, _parent, _scopeId) => {
											if (_push) _push(`${ssrInterpolate(maintainer.name)}`);
											else return [createTextVNode(toDisplayString(maintainer.name), 1)];
										}),
										_: 2
									}, _parent, _scopeId));
									else return [createVNode(_component_i18n_t, { keypath: "package.maintainers.maintainer_template" }, {
										avatar: withCtx(() => [createVNode(_component_UserAvatar, {
											username: maintainer.name,
											size: "xs",
											"aria-hidden": "true"
										}, null, 8, ["username"])]),
										char126: withCtx(() => [createTextVNode("~")]),
										name: withCtx(() => [createTextVNode(toDisplayString(maintainer.name), 1)]),
										_: 2
									}, 1024)];
								}),
								_: 2
						...
						_push(`<!--]--></ul>`);
						if (!unref(canManageOwners) && unref(hiddenMaintainersCount) > 0) _push(ssrRenderComponent(_component_ButtonBase, {
							class: "mt-2",
						...
						createVNode("ul", {
							...
							return openBlock(), createBlock("li", {
								...
								maintainer.name ? (openBlock(), createBlock(_component_LinkBase, {
									...
									default: withCtx(() => [createVNode(_component_i18n_t, { keypath: "package.maintainers.maintainer_template" }, {
										avatar: withCtx(() => [createVNode(_component_UserAvatar, {
											username: maintainer.name,
											size: "xs",
											"aria-hidden": "true"
...
//#endregion
//#region app/components/Package/Maintainers.vue
var _sfc_setup$3 = Maintainers_vue_vue_type_script_setup_true_lang_default.setup;
...
//#endregion
//#region app/components/ReadmeTocDropdown.vue?vue&type=script&setup=true&lang.ts
var ReadmeTocDropdown_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		const itemScrollIntoView = (index) => {
			const item = props.toc[index];
			if (!item) return;
			const el = (void 0).getElementById(`${listboxId}-${item.id}`);
			if (el) el.scrollIntoView({ block: "center" });
		};
		watch(isOpen, (open) => {
			if (open && highlightedIndex.value >= 0) itemScrollIntoView(highlightedIndex.value);
		}, { flush: "post" });
		return (_ctx, _push, _parent, _attrs) => {
			const _component_ButtonBase = Base_default$1;
			const _component_NuxtLink = nuxt_link_default;
...
//#endregion
//#region app/components/ReadmeTocDropdown.vue
var _sfc_setup$2 = ReadmeTocDropdown_vue_vue_type_script_setup_true_lang_default.setup;
...
//#endregion
//#region app/components/PackageProvenanceSection.vue?vue&type=script&setup=true&lang.ts
...
//#endregion
//#region app/components/PackageProvenanceSection.vue
var _sfc_setup$1 = PackageProvenanceSection_vue_vue_type_script_setup_true_lang_default.setup;
...
//#endregion
//#region app/composables/useActiveTocItem.ts
/**
...
//#endregion
//#region app/utils/publish-security.ts
var TRUST_RANK = {
	none: 0,
	provenance: 1,
	trustedPublisher: 2
...
//#endregion
//#region app/composables/useViewOnGitProvider.ts
/**
* Return the text "see on {git provider}" based on the given provider
*/
function useViewOnGitProvider(provider) {
	const { t } = useI18n();
	return computed(() => {
		const uProvider = toValue(provider);
		if (!uProvider) return t("common.view_on.git_repo");
		switch (uProvider) {
			case "github": return t("common.view_on.github");
			case "gitlab": return t("common.view_on.gitlab");
			case "bitbucket": return t("common.view_on.bitbucket");
			case "gitea": return t("common.view_on.gitea");
			case "forgejo": return t("common.view_on.forgejo");
			case "codeberg": return t("common.view_on.codeberg");
			case "sourcehut": return t("common.view_on.sourcehut");
			case "gitee": return t("common.view_on.gitee");
			case "tangled": return t("common.view_on.tangled");
			case "radicle": return t("common.view_on.radicle");
			case "git": return t("common.view_on.git_repo");
		}
		return t("common.view_on.git_repo");
	});
}
//#endregion
//#region app/pages/package/[[org]]/[name].vue?vue&type=script&setup=true&lang.ts
var _name__vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	async setup(__props) {
		...
		watch([resolvedVersion, resolvedStatus], ([version, status]) => {
			if (version && status === "success") fetchInstallSize();
		}, { immediate: true });
		...
		const pkgDescription = useMarkdown(() => ({ text: pkg.value?.description ?? "" }));
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			const _component_DevOnly = dev_only_default;
			const _component_ButtonBase = Base_default$1;
			const _component_PackageSkeleton = Skeleton_default;
			const _component_PackageHeader = Header_default;
			const _component_PackageExternalLinks = ExternalLinks_default;
			...
			const _component_PackageDownloadButton = DownloadButton_default;
			const _component_i18n_t = resolveComponent("i18n-t");
			...
			_push(`<!--[-->`);
			if (unref(isVersionsRoute)) _push(ssrRenderComponent(_component_NuxtPage, null, null, _parent));
			else _push(ssrRenderComponent(_component_DevOnly, null, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(ssrRenderComponent(_component_ButtonBase, {
						...
						"aria-pressed": unref(showSkeleton),
						onClick: ($event) => showSkeleton.value = !unref(showSkeleton)
					}, {
						default: withCtx((_, _push, _parent, _scopeId) => {
							if (_push) _push(`<span class="text-xs"${_scopeId}>Skeleton</span>`);
							else return [createVNode("span", { class: "text-xs" }, "Skeleton")];
						}),
						_: 1
					}, _parent, _scopeId));
					else return [createVNode(_component_ButtonBase, {
						...
						default: withCtx(() => [createVNode("span", { class: "text-xs" }, "Skeleton")]),
						_: 1
					}, 8, ["aria-pressed", "onClick"])];
				}),
				_: 1
			}, _parent));
			if (!unref(isVersionsRoute)) {
				_push(`<main class="flex-1 pb-8">`);
				if (unref(isSpaFallback) || !unref(hasServerContentOnly) && (unref(showSkeleton) || unref(status) === "pending")) _push(ssrRenderComponent(_component_PackageSkeleton, null, null, _parent));
				else if (unref(isHydratingWithServerContent) || unref(hasServerContentOnly) && unref(serverRenderedHtml) && (!unref(pkg) || unref(readmeData)?.defaultValue)) _push(`<article id="package-article" class="${ssrRenderClass([_ctx.$style.packagePage, "container w-full"])}">${unref(serverRenderedHtml) ?? ""}</article>`);
				else if (unref(pkg)) {
					_push(`<!--[-->`);
					_push(ssrRenderComponent(_component_PackageHeader, {
						pkg: unref(pkg),
						"resolved-version": unref(resolvedVersion),
						"display-version": unref(displayVersion),
						"latest-version": unref(latestVersion),
						"provenance-data": unref(provenanceData),
						"provenance-status": unref(provenanceStatus),
						class: _ctx.$style.areaHeader,
						page: "main",
						"version-url-pattern": unref(versionUrlPattern)
					}, null, _parent));
					_push(`<article id="package-article" class="${ssrRenderClass([_ctx.$style.packagePage, "container w-full"])}"><section class="${ssrRenderClass(_ctx.$style.areaDetails)}"><div class="mb-4 pt-4"><div class="max-w-2xl">`);
					...
					_push(`</div>`);
					_push(ssrRenderComponent(_component_PackageExternalLinks, {
						pkg: unref(pkg),
						jsrInfo: unref(jsrInfo)
					}, null, _parent));
					...
					if (unref(dependencyCount) > 0 && unref(dependencyCount) !== unref(totalDepsCount)) _push(ssrRenderComponent(_component_ClientOnly, null, { fallback: withCtx((_, _push, _parent, _scopeId) => {
						...
						default: withCtx((_, _push, _parent, _scopeId) => {
							if (_push) {
								_push(ssrRenderComponent(_component_LinkBase, {
									variant: "button-secondary",
									size: "sm",
									to: `https://npmgraph.js.org/?q=${unref(pkg).name}${unref(resolvedVersion) ? `@${unref(resolvedVersion)}` : ""}`,
					...
					if (unref(sizeTooltip)) _push(ssrRenderComponent(_component_TooltipApp, {
						text: unref(sizeTooltip),
						interactive: ""
					}, {
						default: withCtx((_, _push, _parent, _scopeId) => {
					...
					if (unref(displayVersion)?.dist?.unpackedSize !== unref(installSize)?.totalSize) {
						...
						else if (unref(installSize)?.totalSize) _push(`<span dir="ltr"><span class="text-fg-subtle">(</span>${ssrInterpolate(unref(bytesFormatter).format(unref(installSize).totalSize))}<span class="text-fg-subtle">)</span></span>`);
					...
					if (unref(isBinaryOnly)) {
						...
						_push(`</h2><div class="flex items-center gap-2">`);
						if (unref(displayVersion)) _push(ssrRenderComponent(_component_PackageDownloadButton, {
							"package-name": unref(pkg).name,
							version: unref(displayVersion)
						}, null, _parent));
						else _push(`<!---->`);
						_push(ssrRenderComponent(_component_PackageManagerSelect, null, null, _parent));
						_push(`</div></div><div>`);
						...
						_push(ssrRenderComponent(_component_TerminalInstall, {
							"package-name": unref(pkg).name,
							"requested-version": unref(requestedVersion) && unref(requestedVersion) !== "latest" ? unref(resolvedVersion) : null,
					...
					_push(ssrRenderComponent(_component_PackageSidebar, { class: _ctx.$style.areaSidebar }, {
						default: withCtx((_, _push, _parent, _scopeId) => {
							if (_push) {
								_push(`<div class="flex flex-col gap-4 sm:gap-6 xl:pt-4"${_scopeId}>`);
								...
								_push(`</div>`);
							} else return [createVNode("div", { class: "flex flex-col gap-4 sm:gap-6 xl:pt-4" }, [
					...
					_push(`<section id="readme" class="${ssrRenderClass([_ctx.$style.areaReadme, "min-w-0 scroll-mt-20"])}"><div class="${ssrRenderClass([{ "bg-bg border-border border-b": unref(isReadmeHeaderPinned) }, "flex [@media(min-height:800px)]:sticky z-10 flex-wrap items-center justify-between mb-3 py-2 -mx-1 px-2 transition-shadow duration-200"])}" style="${ssrRenderStyle({ top: unref(readmeStickyTop) })}"><h2 id="readme-heading" class="group text-fg-subtle uppercase font-medium">`);
					...
					if (unref(readmeData)?.html) _push(ssrRenderComponent(_component_Readme, { html: unref(readmeData).html }, null, _parent));
						...
						if (unref(repositoryUrl)) _push(`<a${ssrRenderAttr("href", unref(repositoryUrl))} target="_blank" rel="noopener noreferrer" class="link text-fg underline underline-offset-4 decoration-fg-subtle hover:decoration-fg hover:text-fg transition-colors duration-200">${ssrInterpolate(unref(viewOnGitProvider))}</a>`);
						else _push(`<!---->`);
						_push(`</p>`);
					}
					...
					_push(`<div role="alert" class="flex flex-col items-center py-20 text-center container w-full"><h1 class="font-mono text-2xl font-medium mb-4">${ssrInterpolate(unref($t)("package.not_found"))}</h1><p class="text-fg-muted mb-8">${ssrInterpolate(unref(error)?.message ?? unref($t)("package.not_found_message"))}</p>`);
					_push(ssrRenderComponent(_component_LinkBase, {
						variant: "button-secondary",
						to: { name: "index" }
					}, {
...
var _name__vue_vue_type_style_index_0_lang_module_default = {
	packagePage: "_packagePage_1d2o2_2",
	areaDetails: "_areaDetails_1d2o2_50",
	areaInstall: "_areaInstall_1d2o2_54",
	areaVulns: "_areaVulns_1d2o2_65",
	areaReadme: "_areaReadme_1d2o2_70",
	areaSidebar: "_areaSidebar_1d2o2_78"
};
//#endregion
//#region app/pages/package/[[org]]/[name].vue
...
//# sourceMappingURL=_name_-BqjBBlka.mjs.map
