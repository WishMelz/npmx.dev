import { f as fetchDefaults, c as useAsyncData, d as useRequestFetch } from './server.mjs';
...
function generateOptionSegments(opts) {
	...
	if (opts.body) {
		...
		} else if (isPlainObject(value)) segments.push(hash(reactive(value)));
		else try {
...
//# sourceMappingURL=fetch-BX-wNfYP.mjs.map
