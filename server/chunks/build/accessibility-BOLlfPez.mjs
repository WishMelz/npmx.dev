import { u as useI18n, a as useSeoMeta$1, n as nuxt_link_default } from './server-placeholder-C9fYItBT.mjs';
...
//#region app/pages/accessibility.vue?vue&type=script&setup=true&lang.ts
var accessibility_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(`</div></header><section class="max-w-none space-y-8"><p class="text-fg-muted leading-relaxed">`);
...
//#endregion
//#region app/pages/accessibility.vue
...
//# sourceMappingURL=accessibility-BOLlfPez.mjs.map
