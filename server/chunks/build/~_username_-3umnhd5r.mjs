import { d as useRoute, i as useRouter, a as useSeoMeta$1, B as Base_default, Q as useSearchProvider, c as useNuxtApp, u as useI18n, t as Base_default$1 } from './server-placeholder-C9fYItBT.mjs';
...
import { L as LoadingSpinner_default, u as useAlgoliaSearch, e as emptySearchResponse } from './LoadingSpinner-Ch8PmXtt.mjs';
import { F as Field_default } from './Field-BPqWwnWu.mjs';
import { L as List_default } from './List-DqbTIfaS.mjs';
...
import { aO as normalizeSearchParam } from '../nitro/nitro.mjs';
import 'devalue';
...
//#region app/components/Package/ListControls.vue?vue&type=script&setup=true&lang.ts
...
//#endregion
//#region app/components/Package/ListControls.vue
...
//#endregion
//#region app/composables/npm/useUserPackages.ts
...
function useUserPackages(username) {
	...
	*  searchProvider when Algolia returns empty and we fall through to npm) */
	...
	const asyncData = useLazyAsyncData(() => `user-packages:${searchProviderValue.value}:${toValue(username)}`, async (_nuxtApp, { signal }) => {
...
//#endregion
//#region app/pages/~[username]/index.vue?vue&type=script&setup=true&lang.ts
var index_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(`</div><div class="ms-auto text-end"><nav aria-label="External links"><a${ssrRenderAttr("href", `https://www.npmjs.com/~${unref(username)}`)} target="_blank" rel="noopener noreferrer" class="link-subtle font-mono text-sm inline-flex items-center gap-1.5"${ssrRenderAttr("title", _ctx.$t("common.view_on.npm"))}><span class="i-simple-icons:npm w-4 h-4" aria-hidden="true"></span> npm </a></nav><p class="text-fg-subtle text-xs mt-1 flex items-center gap-1.5 justify-end cursor-help"${ssrRenderAttr("title", _ctx.$t("common.vanity_downloads_hint", { count: unref(filteredCount) }, unref(filteredCount)))}><span class="i-lucide:chart-line w-3.5 h-3.5" aria-hidden="true"></span><span class="font-mono">${ssrInterpolate(_ctx.$n(unref(totalWeeklyDownloads)))} ${ssrInterpolate(_ctx.$t("common.per_week"))}</span></p></div></div></header>`);
...
//#endregion
//#region app/pages/~[username]/index.vue
...
//# sourceMappingURL=~_username_-3umnhd5r.mjs.map
