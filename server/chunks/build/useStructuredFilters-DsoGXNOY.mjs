import { ct as useRoute$1, lt as useRouter$1, H as useI18n, a as _plugin_vue_export_helper_default, p as onClickOutside, m as onKeyDown, i as Base_default, M as Base_default$1 } from './server.mjs';
import { A as App_default, S as Static_default } from './App-cOlf6p32.mjs';
import { F as Field_default } from './Field-CwiCxWgG.mjs';
import { computed, shallowRef, watch, ref, defineComponent, useModel, mergeProps, unref, isRef, mergeModels, useTemplateRef, useId, withCtx, createTextVNode, toDisplayString, createVNode, useSSRContext } from 'vue';
...
import { aC as normalizeSearchParam, aW as DEFAULT_FILTERS, aX as DEFAULT_PREFERENCES, aY as DEFAULT_COLUMNS, aZ as DOWNLOAD_RANGES, a_ as UPDATED_WITHIN_OPTIONS, aV as parseSortOption, a$ as SORT_KEYS, b0 as buildSortOption, b1 as PAGE_SIZE_OPTIONS, b2 as SEARCH_SCOPE_VALUES, b3 as SECURITY_FILTER_VALUES } from '../nitro/nitro.mjs';
...
var _sfc_setup$6 = ViewModeToggle_vue_vue_type_script_setup_true_lang_default.setup;
...
var ColumnPicker_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(`<div${ssrRenderAttrs(mergeProps({ class: "relative" }, _attrs))} data-v-1aa1b9de>`);
			...
			if (unref(isOpen)) {
				_push(`<div${ssrRenderAttr("id", unref(menuId))} class="absolute top-full inset-ie-0 sm:inset-is-auto sm:inset-ie-0 mt-2 w-60 bg-bg-subtle border border-border rounded-lg shadow-lg z-20" role="group"${ssrRenderAttr("aria-label", unref($t)("filters.columns.show"))} data-v-1aa1b9de><div class="py-1" data-v-1aa1b9de><div class="px-3 py-2 text-xs font-mono text-fg-subtle uppercase tracking-wider border-b border-border" aria-hidden="true" data-v-1aa1b9de>${ssrInterpolate(unref($t)("filters.columns.show"))}</div><div class="py-1 max-h-64 overflow-y-auto" data-v-1aa1b9de><!--[-->`);
				ssrRenderList(unref(toggleableColumns), (column) => {
					_push(`<label class="${ssrRenderClass([column.disabled ? "opacity-50 cursor-not-allowed" : "hover:bg-bg-muted", "flex gap-2 items-center px-3 py-2 transition-colors duration-200"])}" data-v-1aa1b9de><input type="checkbox"${ssrIncludeBooleanAttr(column.visible) ? " checked" : ""}${ssrIncludeBooleanAttr(column.disabled) ? " disabled" : ""}${ssrRenderAttr("aria-describedby", column.disabled ? `${column.id}-disabled-reason` : void 0)} class="w-4 h-4 accent-fg bg-bg-muted border-border rounded disabled:opacity-50" data-v-1aa1b9de><span class="text-sm text-fg-muted font-mono flex-1" data-v-1aa1b9de>${ssrInterpolate(getColumnLabel(column.id))}</span>`);
					if (column.disabled) _push(ssrRenderComponent(_component_TooltipApp, {
						...
						default: withCtx((_, _push, _parent, _scopeId) => {
							if (_push) _push(`<span class="size-4 flex justify-center items-center text-xs border rounded-full" data-v-1aa1b9de${_scopeId}>i</span>`);
				...
				_push(`<!--]--></div><div class="border-t border-border py-1" data-v-1aa1b9de>`);
...
var _sfc_setup$5 = ColumnPicker_vue_vue_type_script_setup_true_lang_default.setup;
...
var ColumnPicker_default = /* @__PURE__ */ Object.assign(_plugin_vue_export_helper_default(ColumnPicker_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-1aa1b9de"]]), { __name: "ColumnPicker" });
...
var Panel_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			const _component_ButtonBase = Base_default;
			_push(`<div${ssrRenderAttrs(mergeProps({ class: "border border-border rounded-lg bg-bg-subtle" }, _attrs))} data-v-b3ec7796><button type="button" class="w-full flex items-center gap-3 px-4 py-3 text-start hover:bg-bg-muted transition-colors duration-200 focus-visible:ring-2 focus-visible:ring-fg focus-visible:ring-inset"${ssrRenderAttr("aria-expanded", unref(isExpanded))} data-v-b3ec7796><span class="flex items-center gap-2 text-sm font-mono text-fg shrink-0" data-v-b3ec7796><span class="i-carbon-filter w-4 h-4" aria-hidden="true" data-v-b3ec7796></span> ${ssrInterpolate(unref($t)("filters.title"))}</span>`);
			if (!unref(isExpanded) && unref(hasActiveFilters)) _push(`<span class="text-xs font-mono text-fg-muted truncate" data-v-b3ec7796>${ssrInterpolate(unref(filterSummary))}</span>`);
			else _push(`<!---->`);
			_push(`<span class="${ssrRenderClass([{ "rotate-180": unref(isExpanded) }, "i-carbon-chevron-down w-4 h-4 text-fg-subtle transition-transform duration-200 shrink-0 ms-auto"])}" aria-hidden="true" data-v-b3ec7796></span></button>`);
			if (unref(isExpanded)) {
				_push(`<div class="px-4 pb-5 border-t border-border" data-v-b3ec7796><div class="pt-4" data-v-b3ec7796><div class="flex items-center gap-3 mb-1" data-v-b3ec7796><label for="filter-search" class="text-sm font-mono text-fg-muted" data-v-b3ec7796>${ssrInterpolate(unref($t)("filters.search"))}</label><div class="inline-flex rounded-md border border-border p-0.5 bg-bg" role="group"${ssrRenderAttr("aria-label", unref($t)("filters.search_scope"))} data-v-b3ec7796><!--[-->`);
				ssrRenderList(unref(SEARCH_SCOPE_VALUES), (scope) => {
					_push(`<button type="button" class="${ssrRenderClass([__props.filters.searchScope === scope ? "bg-bg-muted text-fg" : "text-fg-muted hover:text-fg", "px-2 py-0.5 text-xs font-mono rounded-sm transition-colors duration-200 focus-visible:ring-2 focus-visible:ring-fg focus-visible:ring-offset-1"])}"${ssrRenderAttr("aria-pressed", __props.filters.searchScope === scope)}${ssrRenderAttr("title", getScopeDescriptionKey(scope))} data-v-b3ec7796>${ssrInterpolate(getScopeLabelKey(scope))}</button>`);
				});
				_push(`<!--]--></div></div>`);
				_push(ssrRenderComponent(_component_InputBase, {
					id: "filter-search",
					type: "text",
					value: __props.filters.text,
				...
				_push(`</div><fieldset class="border-0 p-0 m-0 mt-4" data-v-b3ec7796><legend class="block text-sm font-mono text-fg-muted mb-1" data-v-b3ec7796>${ssrInterpolate(unref($t)("filters.weekly_downloads"))}</legend><div class="flex flex-wrap gap-2" role="radiogroup"${ssrRenderAttr("aria-label", unref($t)("filters.weekly_downloads"))} data-v-b3ec7796><!--[-->`);
				...
				_push(`<!--]--></div></fieldset><fieldset class="border-0 p-0 m-0 mt-4" data-v-b3ec7796><legend class="block text-sm font-mono text-fg-muted mb-1" data-v-b3ec7796>${ssrInterpolate(unref($t)("filters.updated_within"))}</legend><div class="flex flex-wrap gap-2" role="radiogroup"${ssrRenderAttr("aria-label", unref($t)("filters.updated_within"))} data-v-b3ec7796><!--[-->`);
				...
				_push(`<!--]--></div></fieldset><fieldset class="border-0 p-0 m-0 mt-4" data-v-b3ec7796><legend class="flex items-center gap-2 text-sm font-mono text-fg-muted mb-1" data-v-b3ec7796>${ssrInterpolate(unref($t)("filters.security"))} <span class="text-xs px-1.5 py-0.5 rounded bg-bg-muted text-fg-subtle" data-v-b3ec7796>${ssrInterpolate(unref($t)("filters.columns.coming_soon"))}</span></legend><div class="flex flex-wrap gap-2" role="radiogroup"${ssrRenderAttr("aria-label", unref($t)("filters.security"))} data-v-b3ec7796><!--[-->`);
				...
				if (unref(displayedKeywords).length > 0) {
					_push(`<fieldset class="border-0 p-0 m-0 mt-4" data-v-b3ec7796><legend class="block text-sm font-mono text-fg-muted mb-1" data-v-b3ec7796>${ssrInterpolate(unref($t)("filters.keywords"))}</legend><div class="flex flex-wrap gap-1.5" role="group"${ssrRenderAttr("aria-label", unref($t)("filters.keywords"))} data-v-b3ec7796><!--[-->`);
...
var Panel_default = /* @__PURE__ */ Object.assign(_plugin_vue_export_helper_default(Panel_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-b3ec7796"]]), { __name: "FilterPanel" });
	...
	setup(__props, { emit: __emit }) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			if (__props.chips.length > 0) {
				_push(`<div${ssrRenderAttrs(mergeProps({ class: "flex flex-wrap items-center gap-2" }, _attrs))} data-v-09f61161><!--[-->`);
				ssrRenderList(__props.chips, (chip) => {
					_push(ssrRenderComponent(_component_TagStatic, {
						...
						default: withCtx((_, _push, _parent, _scopeId) => {
							if (_push) _push(`<span class="text-fg-subtle text-xs" data-v-09f61161${_scopeId}>${ssrInterpolate(chip.label)}:</span><span class="max-w-32 truncate" data-v-09f61161${_scopeId}>${ssrInterpolate(Array.isArray(chip.value) ? chip.value.join(", ") : chip.value)}</span><button type="button" class="flex items-center p-1 -m-1 hover:text-fg rounded-full transition-colors duration-200 focus-visible:ring-2 focus-visible:ring-fg focus-visible:ring-offset-1"${ssrRenderAttr("aria-label", _ctx.$t("filters.remove_filter", { label: chip.label }))} data-v-09f61161${_scopeId}><span class="i-carbon-close w-3 h-3" aria-hidden="true" data-v-09f61161${_scopeId}></span></button>`);
							else return [
				...
				_push(`<!--]-->`);
				if (__props.chips.length > 1) _push(`<button type="button" class="text-sm p-0.5 text-fg-muted hover:text-fg underline transition-colors duration-200 focus-visible:ring-2 focus-visible:ring-fg focus-visible:ring-offset-2" data-v-09f61161>${ssrInterpolate(_ctx.$t("filters.clear_all"))}</button>`);
				else _push(`<!---->`);
				_push(`</div>`);
			} else _push(`<!---->`);
		};
...
var Chips_default = /* @__PURE__ */ Object.assign(_plugin_vue_export_helper_default(Chips_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-09f61161"]]), { __name: "FilterChips" });
var ListToolbar_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(`<div class="flex-1"></div><div class="flex flex-wrap items-center gap-3 sm:justify-end justify-between w-full sm:w-auto"><div class="flex items-center gap-1 shrink-0 order-1 sm:order-1">`);
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			if (unref(shouldShowControls)) {
				...
				if (unref(effectiveMode) === "paginated") {
					...
					_push(`<div class="flex items-center absolute inset-ie-2 top-1/2 -translate-y-1/2 text-fg-subtle pointer-events-none" aria-hidden="true"><span class="i-carbon-chevron-down w-3 h-3"></span></div></div>`);
				} else _push(`<!---->`);
				_push(`</div>`);
				if (unref(effectiveMode) === "paginated") {
...
//# sourceMappingURL=useStructuredFilters-DsoGXNOY.mjs.map
