import { u as useAsyncData, a as useLazyAsyncData } from './asyncData-Dr04OizO.mjs';
import { ab as useCachedFetch } from './server-placeholder-C9fYItBT.mjs';
import { computed, toValue } from 'vue';
import { bg as normalizeGitUrl, bh as joinURL, w as parseRepoUrl, bi as GITLAB_HOSTS } from '../nitro/nitro.mjs';

//#region app/composables/npm/useResolvedVersion.ts
...
//#endregion
//#region app/composables/useRepositoryUrl.ts
function useRepositoryUrl(requestedVersion) {
	return { repositoryUrl: computed(() => {
...
//#endregion
//#region app/composables/useRepoMeta.ts
var REPO_META_TTL = 600;
var UNGH_REPO_META_TTL = 3600 * 3;
var providers = [
	{
		id: "github",
		parse(url) {
...
export { useRepositoryUrl as a, useRepoMeta as b, useResolvedVersion as u };
//# sourceMappingURL=useRepoMeta-BtIq7MgE.mjs.map
