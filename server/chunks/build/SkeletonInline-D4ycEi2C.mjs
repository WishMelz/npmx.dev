import { i as _plugin_vue_export_helper_default, X as useRouter$1, l as useClipboard } from './server.mjs';
...
var Readme_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			}, _attrs))} data-v-99f60007>${__props.html ?? ""}</article>`);
		};
	}
});
...
var Readme_default = /* @__PURE__ */ Object.assign(_plugin_vue_export_helper_default(Readme_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-99f60007"]]), { __name: "Readme" });
var _sfc_main = {};
...
//# sourceMappingURL=SkeletonInline-D4ycEi2C.mjs.map
