import { k as useI18n, U as useSeoMeta$1, X as useRouter$1, A as useAppConfig, r as nuxt_time_default, j as nuxt_link_default } from './server.mjs';
...
var privacy_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(`</p><ul class="space-y-3 text-fg-muted list-none p-0"><li class="flex items-start gap-3"><span class="text-fg-subtle shrink-0 mt-1">—</span><span>`);
			_push(ssrRenderComponent(_component_i18n_t, {
			...
			_push(`</span></li><li class="flex items-start gap-3"><span class="text-fg-subtle shrink-0 mt-1">—</span><span>`);
			_push(ssrRenderComponent(_component_i18n_t, {
			...
			_push(`</p><p class="text-fg-muted leading-relaxed mb-4">${ssrInterpolate(unref($t)("privacy_policy.analytics.p2"))}</p><ul class="space-y-3 text-fg-muted list-none p-0 mb-4"><li class="flex items-start gap-3"><span class="text-fg-subtle shrink-0 mt-1">—</span><span>${ssrInterpolate(unref($t)("privacy_policy.analytics.li1"))}</span></li><li class="flex items-start gap-3"><span class="text-fg-subtle shrink-0 mt-1">—</span><span>${ssrInterpolate(unref($t)("privacy_policy.analytics.li2"))}</span></li><li class="flex items-start gap-3"><span class="text-fg-subtle shrink-0 mt-1">—</span><span>${ssrInterpolate(unref($t)("privacy_policy.analytics.li3"))}</span></li><li class="flex items-start gap-3"><span class="text-fg-subtle shrink-0 mt-1">—</span><span>${ssrInterpolate(unref($t)("privacy_policy.analytics.li4"))}</span></li></ul><p class="text-fg-muted leading-relaxed">${ssrInterpolate(unref($t)("privacy_policy.analytics.p3"))}</p></div><div><h2 class="text-lg text-fg-subtle uppercase tracking-wider mb-4">${ssrInterpolate(unref($t)("privacy_policy.authenticated.title"))}</h2><p class="text-fg-muted leading-relaxed mb-4">`);
			_push(ssrRenderComponent(_component_i18n_t, {
			...
			_push(ssrRenderComponent(_component_i18n_t, {
				...
				link: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<a href="https://github.com/npmx-dev/npmx.dev/issues" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-1 text-fg-muted hover:text-fg underline decoration-fg-subtle/50 hover:decoration-fg"${_scopeId}>${ssrInterpolate(unref($t)("privacy_policy.contact.link"))} <span class="i-carbon:launch rtl-flip w-4 h-4" aria-hidden="true"${_scopeId}></span></a>`);
						...
						class: "i-carbon:launch rtl-flip w-4 h-4",
						"aria-hidden": "true"
					})])];
				}),
				_: 1
...
//# sourceMappingURL=privacy-Hqynxf3j.mjs.map
