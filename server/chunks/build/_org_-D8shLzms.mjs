import { H as useI18n, ct as useRoute$1, lt as useRouter$1, o as useConnector, ot as showError, tt as useHead$1, nt as useSeoMeta$1, Q as client_only_default, I as Base_default$2, u as useSearchProvider, Z as useLazyAsyncData, at as createError$1 } from './server.mjs';
import { d as defineOgImageComponent } from './defineOgImageComponent-DtDCPnhJ.mjs';
import { L as LoadingSpinner_default, u as useAlgoliaSearch, e as emptySearchResponse, m as metaToSearchResult } from './LoadingSpinner-er2gks8E.mjs';
...
import { L as List_default } from './List-C77sESZJ.mjs';
...
import { aC as normalizeSearchParam, b9 as mapWithConcurrency, m as encodePackageName } from '../nitro/nitro.mjs';
import 'devalue';
import 'lru-cache';
import '@unocss/core';
...
function useOrgPackages(orgName) {
	...
	return useLazyAsyncData(() => `org-packages:${searchProvider.value}:${toValue(orgName)}`, async ({ ssrContext }, { signal }) => {
		...
		if (searchProvider.value === "algolia") try {
...
//# sourceMappingURL=_org_-D8shLzms.mjs.map
