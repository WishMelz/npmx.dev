//#region app/utils/frameworks.ts
var SHOWCASED_FRAMEWORKS = [
	{
		name: "nuxt",
		package: "nuxt",
...
function isListedFramework(name) {
	return SHOWCASED_FRAMEWORKS.some((f) => f.package === name);
}

export { SHOWCASED_FRAMEWORKS as S, getFrameworkColor as g, isListedFramework as i };
//# sourceMappingURL=frameworks-hCp8-s9f.mjs.map
