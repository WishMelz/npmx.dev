import { a as _plugin_vue_export_helper_default, lt as useRouter$1, g as useClipboard } from './server.mjs';
...
var Readme_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			}, _attrs))} data-v-c2d9ed22>${__props.html ?? ""}</article>`);
		};
	}
});
...
var Readme_default = /* @__PURE__ */ Object.assign(_plugin_vue_export_helper_default(Readme_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-c2d9ed22"]]), { __name: "Readme" });
var _sfc_main = {};
...
//# sourceMappingURL=SkeletonInline-CuzIQzAj.mjs.map
