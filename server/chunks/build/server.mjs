...
import { defineComponent, createElementBlock, watch, computed, toValue, shallowRef, reactive, getCurrentInstance, provide, cloneVNode, h, onServerPrefetch, toRef, isRef, hasInjectionContext, inject, readonly, shallowReadonly, getCurrentScope, onScopeDispose, ref, mergeProps, watchEffect, nextTick, unref, withCtx, openBlock, createBlock, createCommentVNode, renderSlot, toDisplayString, useModel, useTemplateRef, mergeModels, resolveComponent, createApp, createVNode, createTextVNode, defineAsyncComponent, onErrorCaptured, resolveDynamicComponent, shallowReactive, effectScope, customRef, Suspense, Fragment, isReadonly, useSSRContext, toRaw, isShallow, isReactive, Text } from 'vue';
import { u as hash, af as FETCH_CACHE_DEFAULT_TTL, ag as defu, ah as withQuery, ai as klona, c as createError, aj as ACCENT_COLORS, ak as headSymbol, al as BACKGROUND_THEMES, am as useSeoMeta, an as $fetch$1, ao as hasProtocol, ap as isScriptProtocol, aq as joinURL, ar as useHead, as as defuFn, at as parseQuery, au as sanitizeStatusCode, av as parseURL, aw as encodePath, ax as decodePath, ay as createHooks, az as getContext, aA as withTrailingSlash, aB as withoutTrailingSlash, aC as normalizeSearchParam, aD as baseURL, aE as executeAsync, W as NPM_API, N as NPM_REGISTRY, a7 as getRequestURL, aF as resolveUnrefHeadInput, aG as toRouteMatcher, aH as createRouter, aI as withoutBase, aJ as getRequestHeader, aK as getCookie, aL as withLeadingSlash, aM as withBase, aN as parse$1, aO as destr, aP as isEqual, aQ as createDefu, aR as parsePath, aS as setCookie, aT as deleteCookie } from '../nitro/nitro.mjs';
import { debounce } from 'perfect-debounce';
import { stringify, parse } from 'devalue';
import { ssrRenderAttrs, ssrInterpolate, ssrRenderSlot, ssrRenderComponent, ssrRenderClass, ssrGetDynamicModelProps, ssrRenderSuspense, ssrRenderVNode, ssrRenderAttr, ssrRenderList } from 'vue/server-renderer';
import 'lru-cache';
import '@unocss/core';
...
var virtual_nuxt__2Fhome_2Frunner_2Fwork_2Fnpmx_dev_2Fnpmx_dev_2Fnode_modules_2F_cache_2Fnuxt_2F_nuxt_2Froutes_default = [
	{
		name: "about",
		path: "/about",
		component: () => import('./about-DmgAOZ5F.mjs')
	},
	{
		name: "index",
		path: "/",
		component: () => import('./pages-DOWQLUy2.mjs')
	},
	{
		name: "search",
		path: "/search",
		component: () => import('./search-Q24Scoo-.mjs')
	},
	{
		name: "compare",
		path: "/compare",
		component: () => import('./compare-DYBtiaod.mjs')
	},
	{
		name: "privacy",
		path: "/privacy",
		component: () => import('./privacy-CrNZyerr.mjs')
	},
	{
		name: "settings",
		path: "/settings",
		component: () => import('./settings-CT20cTFu.mjs')
	},
	{
		name: "org",
		path: "/org/:org()",
		component: () => import('./_org_-D8shLzms.mjs')
	},
	{
		name: "~username-orgs",
		path: "/~:username()/orgs",
		component: () => import('./orgs-QxblCIEh.mjs')
	},
	{
		name: "~username",
		path: "/~:username()",
		component: () => import('./~_username_-VaKylfgy.mjs')
	},
	{
		name: "code",
		path: "/package-code/:path+",
		alias: ["/package/code/:path+", "/code/:path+"],
		component: () => import('./_...path_-CT5OIJmj.mjs')
	},
	{
		name: "docs",
		path: "/package-docs/:path+",
		alias: ["/package/docs/:path+", "/docs/:path+"],
		component: () => import('./_...path_-BchXbY4X.mjs')
	},
	{
		name: void 0,
		path: "/package/:org?/:name()",
		component: () => import('./_name_-C0KDqtXV.mjs'),
		children: [{
			name: "package",
			path: "",
			component: () => import('./_name_-BsGHR1cs.mjs')
		}, {
			name: "package-version",
			path: "v/:version()",
			component: () => import('./_version_-Be8-DntF.mjs')
		}]
	}
];
/**
...
var virtual_nuxt__2Fhome_2Frunner_2Fwork_2Fnpmx_dev_2Fnpmx_dev_2Fnode_modules_2F_cache_2Fnuxt_2F_nuxt_2Fapp_config_default = /* @__PURE__ */ defuFn({
	...
	"buildInfo": {
		"version": "0.0.0",
		"time": 1770694521524,
		"commit": "badd0aeba9de545071a239581340d2badf2134d9",
		"shortCommit": "badd0ae",
		"branch": "main",
		"env": "canary",
		"privacyPolicyDate": "2026-02-10T03:35:21.524Z"
	}
});
...
const localeLoaders = {
	...
	"no-NO": [{
		key: "locale_no_45NO_46json_1ca8a827",
		load: () => import(
			'./no-NO-CEurWnxA.mjs'
			/* webpackChunkName: "locale_no_45NO_46json_1ca8a827" */
),
		cache: true
	}],
	"pl-PL": [{
...
function createNuxtI18nContext(nuxt, vueI18n, defaultLocale) {
	...
	const loadMessagesFromServer = async (locale) => {
		...
		const messages = await $fetch(`/_i18n/-78yWSUZ/${locale}/messages.json`, { headers });
...
var i18n_default$1 = /* @__PURE__ */ defineNuxtPlugin({
	...
	async setup(_nuxt) {
		...
		prerenderRoutes(localeCodes.map((locale) => `/_i18n/-78yWSUZ/${locale}/messages.json`));
...
const componentNames = [
	{
		"hash": "goswxWiX6oQXOKJ-9Lz-d6-0MvlmLrYLQCcG5xsnTGE",
	...
	{
		"hash": "McFhoh14H-mSsBxGWyEMhRqh4Wd60qep0VlwhLV-5IQ",
	...
	},
	{
		...
		"path": "/home/runner/work/npmx.dev/npmx.dev/node_modules/.pnpm/nuxt-og-image@5.1.13_@unhead+vue@2.1.3_vue@3.5.27_typescript@5.9.3___magicast@0.5.1_uns_5ea9d547cc5a8dd0f14aa3fd40f2e912/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/BrandedLogo.vue",
		"category": "community"
	},
	{
		...
		"pascalName": "Frame",
		"kebabName": "frame",
		"path": "/home/runner/work/npmx.dev/npmx.dev/node_modules/.pnpm/nuxt-og-image@5.1.13_@unhead+vue@2.1.3_vue@3.5.27_typescript@5.9.3___magicast@0.5.1_uns_5ea9d547cc5a8dd0f14aa3fd40f2e912/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Frame.vue",
		"category": "community"
	},
	{
		...
		"pascalName": "Nuxt",
		"kebabName": "nuxt",
		"path": "/home/runner/work/npmx.dev/npmx.dev/node_modules/.pnpm/nuxt-og-image@5.1.13_@unhead+vue@2.1.3_vue@3.5.27_typescript@5.9.3___magicast@0.5.1_uns_5ea9d547cc5a8dd0f14aa3fd40f2e912/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Nuxt.vue",
		"category": "community"
	},
	{
		...
		"pascalName": "NuxtSeo",
		"kebabName": "nuxt-seo",
		"path": "/home/runner/work/npmx.dev/npmx.dev/node_modules/.pnpm/nuxt-og-image@5.1.13_@unhead+vue@2.1.3_vue@3.5.27_typescript@5.9.3___magicast@0.5.1_uns_5ea9d547cc5a8dd0f14aa3fd40f2e912/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/NuxtSeo.vue",
		"category": "community"
	},
	{
		...
		"pascalName": "Pergel",
		"kebabName": "pergel",
		"path": "/home/runner/work/npmx.dev/npmx.dev/node_modules/.pnpm/nuxt-og-image@5.1.13_@unhead+vue@2.1.3_vue@3.5.27_typescript@5.9.3___magicast@0.5.1_uns_5ea9d547cc5a8dd0f14aa3fd40f2e912/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Pergel.vue",
		"category": "community"
	},
	{
		...
		"path": "/home/runner/work/npmx.dev/npmx.dev/node_modules/.pnpm/nuxt-og-image@5.1.13_@unhead+vue@2.1.3_vue@3.5.27_typescript@5.9.3___magicast@0.5.1_uns_5ea9d547cc5a8dd0f14aa3fd40f2e912/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/SimpleBlog.vue",
		"category": "community"
	},
	{
		...
		"pascalName": "UnJs",
		"kebabName": "un-js",
		"path": "/home/runner/work/npmx.dev/npmx.dev/node_modules/.pnpm/nuxt-og-image@5.1.13_@unhead+vue@2.1.3_vue@3.5.27_typescript@5.9.3___magicast@0.5.1_uns_5ea9d547cc5a8dd0f14aa3fd40f2e912/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/UnJs.vue",
		"category": "community"
	},
	{
		...
		"pascalName": "Wave",
		"kebabName": "wave",
		"path": "/home/runner/work/npmx.dev/npmx.dev/node_modules/.pnpm/nuxt-og-image@5.1.13_@unhead+vue@2.1.3_vue@3.5.27_typescript@5.9.3___magicast@0.5.1_uns_5ea9d547cc5a8dd0f14aa3fd40f2e912/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Wave.vue",
		"category": "community"
	},
	{
		...
		"path": "/home/runner/work/npmx.dev/npmx.dev/node_modules/.pnpm/nuxt-og-image@5.1.13_@unhead+vue@2.1.3_vue@3.5.27_typescript@5.9.3___magicast@0.5.1_uns_5ea9d547cc5a8dd0f14aa3fd40f2e912/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/WithEmoji.vue",
		"category": "community"
	}
];
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			if (__props.disabled) {
				...
				_push(`</span>`);
			} else _push(ssrRenderComponent(_component_NuxtLink, mergeProps({
				...
				to: __props.to,
				"aria-keyshortcuts": __props.ariaKeyshortcuts,
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						if (unref(isLinkExternal) && !__props.classicon) _push(`<span class="i-carbon:launch rtl-flip size-[1em] opacity-50" aria-hidden="true"${_scopeId}></span>`);
						else if (unref(isLinkAnchor) && unref(isLink)) _push(`<span class="i-carbon:link size-[1em] opacity-0 group-hover/link:opacity-100 transition-opacity duration-200" aria-hidden="true"${_scopeId}></span>`);
						else _push(`<!---->`);
						if (__props.ariaKeyshortcuts) _push(`<kbd class="ms-2 inline-flex items-center justify-center size-4 text-xs text-fg bg-bg-muted border border-border rounded no-underline" aria-hidden="true"${_scopeId}>${ssrInterpolate(__props.ariaKeyshortcuts)}</kbd>`);
						else _push(`<!---->`);
					} else return [
						...
						unref(isLinkExternal) && !__props.classicon ? (openBlock(), createBlock("span", {
							key: 1,
						...
						__props.ariaKeyshortcuts ? (openBlock(), createBlock("kbd", {
							key: 3,
...
var _sfc_setup$15 = Base_vue_vue_type_script_setup_true_lang_default$2.setup;
...
var SearchBox_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		...
		function updateUrlQueryImpl(value) {
		...
		const updateUrlQuery = Object.assign((value) => (isAlgolia.value ? updateUrlQueryAlgolia : updateUrlQueryNpm)(value), { flush: () => (isAlgolia.value ? updateUrlQueryAlgolia : updateUrlQueryNpm).flush() });
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
	_push(`<div${ssrRenderAttrs(mergeProps({ class: "relative flex min-w-28 justify-end" }, _attrs))}><div class="inline-flex gap-x-1 items-center justify-center font-mono border border-border rounded-md text-sm px-4 py-2 bg-transparent text-fg border-none"><span class="font-mono text-sm text-fg-muted">${ssrInterpolate(_ctx.$t("account_menu.connect"))}</span><span class="i-carbon-chevron-down w-3 h-3 text-fg-muted" aria-hidden="true"></span></div></div>`);
}
	...
	setup(__props, { expose: __expose }) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<button${ssrRenderAttrs(mergeProps({
				ref_key: "el",
				ref: el,
				class: ["group cursor-pointer gap-x-1 items-center justify-center font-mono border border-border rounded-md transition-all duration-200 disabled:opacity-40 disabled:cursor-not-allowed disabled:border-transparent", {
					"inline-flex": !__props.block,
					"flex": __props.block,
			...
			ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
			if (__props.ariaKeyshortcuts) _push(`<kbd class="ms-2 inline-flex items-center justify-center w-4 h-4 text-xs text-fg bg-bg-muted border border-border rounded no-underline" aria-hidden="true">${ssrInterpolate(__props.ariaKeyshortcuts)}</kbd>`);
			else _push(`<!---->`);
			_push(`</button>`);
		};
	}
...
var AppHeader_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(`<header${ssrRenderAttrs(mergeProps({ class: "sticky top-0 z-50 border-b border-border" }, _attrs))}><div class="absolute inset-0 bg-bg/80 backdrop-blur-md"></div><nav${ssrRenderAttr("aria-label", unref($t)("nav.main_navigation"))} class="${ssrRenderClass([unref(isOnHomePage) ? "justify-end" : "justify-between", "relative container min-h-14 flex items-center gap-2 z-1"])}">`);
			if (!unref(isSearchExpanded) && !unref(isOnHomePage)) {
				_push(`<button type="button" class="sm:hidden flex-shrink-0 inline-flex items-center gap-2 font-mono text-lg font-medium text-fg hover:text-fg transition-colors duration-200 rounded"${ssrRenderAttr("aria-label", unref($t)("nav.tap_to_search"))}>`);
...
_sfc_main$1.setup = (props, ctx) => {
	const ssrContext = useSSRContext();
	(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt@4.3.1_@parcel+watcher@2.5.6_@types+node@24.10.9_@upstash+redis@1.36.1_@vercel+kv@3_036ed8436c0f527912cdc58fdefcd3ef/node_modules/nuxt/dist/app/components/nuxt-time.vue");
...
var AppFooter_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(`<footer${ssrRenderAttrs(mergeProps({ class: "border-t border-border mt-auto" }, _attrs))} data-v-c297fb01><div class="container py-3 sm:py-8 flex flex-col gap-2 sm:gap-4 text-fg-subtle text-sm" data-v-c297fb01><div class="flex flex-col sm:flex-row sm:flex-wrap items-center sm:items-baseline justify-between gap-2 sm:gap-4" data-v-c297fb01><div data-v-c297fb01><p class="font-mono text-balance m-0 hidden sm:block" data-v-c297fb01>${ssrInterpolate(_ctx.$t("tagline"))}</p></div><div class="hidden sm:flex items-center gap-6 min-h-11 text-xs" data-v-c297fb01>`);
			...
			_push(ssrRenderComponent(_component_LinkBase, { to: "https://docs.npmx.dev" }, {
				default: withCtx((_, _push, _parent, _scopeId) => {
			...
			_push(`<p class="text-xs text-fg-muted text-center sm:text-start m-0" data-v-c297fb01><span class="sm:hidden" data-v-c297fb01>${ssrInterpolate(_ctx.$t("non_affiliation_disclaimer"))}</span><span class="hidden sm:inline" data-v-c297fb01>${ssrInterpolate(_ctx.$t("trademark_disclaimer"))}</span></p></div></footer>`);
		};
	}
});
...
var AppFooter_default = /* @__PURE__ */ Object.assign(_plugin_vue_export_helper_default(AppFooter_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-c297fb01"]]), { __name: "AppFooter" });
function initPreferencesOnPrehydrate() {
	onPrehydrate("(()=>{let e=new Set([`coral`,`amber`,`emerald`,`sky`,`violet`,`magenta`]),t=new Set([`npm`,`pnpm`,`yarn`,`bun`,`deno`,`vlt`]),n=JSON.parse(localStorage.getItem(`npmx-settings`)||`{}`),r=n.accentColorId;r&&e.has(r)&&document.documentElement.style.setProperty(`--accent-color`,`var(--swatch-${r})`);let i=n.preferredBackgroundTheme;i&&(document.documentElement.dataset.bgTheme=i);let a=localStorage.getItem(`npmx-pm`),o=`npm`;if(a)try{let e=JSON.parse(a);t.has(e)&&(o=e)}catch{t.has(a)&&(o=a)}document.documentElement.dataset.pm=o,document.documentElement.dataset.collapsed=n.sidebar?.collapsed?.join(` `)??``})");
}
...
var app_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen flex flex-col bg-bg text-fg" }, _attrs))} data-v-5babbb3c>`);
			...
			_push(`<div id="main-content" class="flex-1 flex flex-col" data-v-5babbb3c>`);
...
var app_default = /* @__PURE__ */ _plugin_vue_export_helper_default(app_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-5babbb3c"]]);
...
var _sfc_main = {
	...
	__ssrInlineRender: true,
	setup(__props) {
		const IslandRenderer = defineAsyncComponent(() => import('./island-renderer-1GB3O5JK.mjs').then((r) => r.default || r));
		const nuxtApp = useNuxtApp();
		nuxtApp.deferHydration();
...
_sfc_main.setup = (props, ctx) => {
	const ssrContext = useSSRContext();
	(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt@4.3.1_@parcel+watcher@2.5.6_@types+node@24.10.9_@upstash+redis@1.36.1_@vercel+kv@3_036ed8436c0f527912cdc58fdefcd3ef/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { server_placeholder_default as $, useDebounceFn as A, setHeadOgImagePrebuilt as B, useMutationObserver as C, useWindowSize as D, useWindowScroll as E, AppLogo_default as F, useFetch as G, useI18n as H, Base_default$2 as I, useRequestEvent as J, useLazyFetch as K, useCachedFetch as L, Base_default$1 as M, isEditableElement as N, createSharedComposable as O, isKeyWithoutModifiers as P, client_only_default as Q, createOgImageMeta as R, useMounted as S, useSupported as T, useAppConfig as U, useOgImageRuntimeConfig as V, nuxt_link_default as W, useAsyncData as X, useState as Y, useLazyAsyncData as Z, useElementBounding as _, _plugin_vue_export_helper_default as a, createError$1 as at, useLocalStorage as b, useAccentColor as c, useRoute$1 as ct, useSettings as d, entry_default as default, useRuntimeConfig as dt, injectHead as et, useColorMode as f, useClipboard as g, onKeyStroke as h, Base_default as i, useRouter as it, useTimeoutFn as j, tryOnScopeDispose as k, useBackgroundTheme as l, useRouter$1 as lt, onKeyDown as m, DateTime_default as n, useSeoMeta$1 as nt, useConnector as o, showError as ot, onClickOutside as p, onPrehydrate as q, nuxt_time_default as r, useRoute as rt, packageRoute as s, navigateTo as st, BuildEnvironment_default as t, useHead$1 as tt, useSearchProvider as u, useNuxtApp as ut, useElementSize as v, useResizeObserver as w, useMediaQuery as x, useEventListener as y, getOgImagePath as z };
