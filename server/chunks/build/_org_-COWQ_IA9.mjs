import { u as useI18n, d as useRoute, i as useRouter, z as useConnector, X as showError, Y as useHead$1, a as useSeoMeta$1, o as client_only_default, B as Base_default, Q as useSearchProvider, k as createError$1 } from './server-placeholder-C9fYItBT.mjs';
...
import { L as LoadingSpinner_default, u as useAlgoliaSearch, e as emptySearchResponse, m as metaToSearchResult } from './LoadingSpinner-Ch8PmXtt.mjs';
...
import { aO as normalizeSearchParam, b6 as mapWithConcurrency, v as encodePackageName } from '../nitro/nitro.mjs';
import 'devalue';
...
//#region app/composables/npm/useOrgPackages.ts
/**
...
//#endregion
//#region app/pages/org/[org].vue?vue&type=script&setup=true&lang.ts
var _org__vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(`</div><div class="ms-auto text-end"><nav aria-label="External links"><a${ssrRenderAttr("href", `https://www.npmjs.com/org/${unref(orgName)}`)} target="_blank" rel="noopener noreferrer" class="link-subtle font-mono text-sm inline-flex items-center gap-1.5"${ssrRenderAttr("title", unref($t)("common.view_on.npm"))}><span class="i-simple-icons:npm w-4 h-4" aria-hidden="true"></span> npm </a></nav><p class="text-fg-subtle text-xs mt-1 flex items-center gap-1.5 justify-end cursor-help"${ssrRenderAttr("title", unref($t)("common.vanity_downloads_hint", { count: unref(filteredCount) }, unref(filteredCount)))}><span class="i-lucide:chart-line w-3.5 h-3.5" aria-hidden="true"></span><span class="font-mono">${ssrInterpolate(_ctx.$n(unref(totalWeeklyDownloads)))} ${ssrInterpolate(unref($t)("common.per_week"))}</span></p></div></div></header>`);
...
//# sourceMappingURL=_org_-COWQ_IA9.mjs.map
