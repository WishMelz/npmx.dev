import { defineComponent, useModel, mergeProps, withCtx, openBlock, createBlock, Fragment, renderList, toDisplayString, mergeModels, useSSRContext } from 'vue';
...
var Field_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(`<span aria-hidden="true" class="${ssrRenderClass([[SELECT_FIELD_ICON_SIZES[__props.size]], "block i-carbon:chevron-down absolute top-1/2 -translate-y-1/2 text-fg-subtle pointer-events-none group-hover/select:text-fg group-focus-within/select:text-fg"])}"></span></div></div>`);
		};
	}
});
...
//# sourceMappingURL=Field-CwiCxWgG.mjs.map
