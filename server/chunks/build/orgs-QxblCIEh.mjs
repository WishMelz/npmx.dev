import { H as useI18n, ct as useRoute$1, o as useConnector, nt as useSeoMeta$1, W as nuxt_link_default, Q as client_only_default } from './server.mjs';
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(ssrRenderComponent(_component_NuxtLink, {
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<span class="i-carbon:arrow-left rtl-flip w-4 h-4" aria-hidden="true"${_scopeId}></span> ${ssrInterpolate(unref($t)("user.orgs_page.back_to_profile"))}`);
					else return [createVNode("span", {
						class: "i-carbon:arrow-left rtl-flip w-4 h-4",
						"aria-hidden": "true"
...
//# sourceMappingURL=orgs-QxblCIEh.mjs.map
