//#region config/i18n.ts
var countryLocaleVariants = {
	ar: [{
		country: true,
		code: "ar-EG",
		name: "العربية"
...
function buildLocales() {
	return Object.values(locales).reduce((acc, data) => {
		...
		if (localeVariants) localeVariants.forEach((l) => {
			const entry = {
				...data,
				code: l.code,
				name: l.name,
...
var currentLocales = buildLocales();
var datetimeFormats = Object.values(currentLocales).reduce((acc, data) => {
...
var numberFormats = Object.values(currentLocales).reduce((acc, data) => {
...
var pluralRules = Object.values(currentLocales).reduce((acc, data) => {
...
//# sourceMappingURL=i18n.config-R4NW47-l.mjs.map
