import { d as useRoute, i as useRouter, u as useI18n, m as Base_default$1, _ as _plugin_vue_export_helper_default, L as onClickOutside, D as onKeyDown, t as Base_default } from './server-placeholder-C9fYItBT.mjs';
...
import { u as usePackageSelection } from './List-DqbTIfaS.mjs';
import { computed, watch, shallowRef, ref, defineComponent, useModel, mergeProps, unref, isRef, withCtx, createTextVNode, toDisplayString, mergeModels, useTemplateRef, useId, createVNode, useSSRContext } from 'vue';
...
import { aR as PAGE_SIZE_OPTIONS, aO as normalizeSearchParam, aS as DEFAULT_FILTERS, aT as DEFAULT_PREFERENCES, aU as DEFAULT_COLUMNS, aV as DOWNLOAD_RANGES, aW as UPDATED_WITHIN_OPTIONS, aQ as parseSortOption, aX as SORT_KEYS, aY as buildSortOption, aZ as SEARCH_SCOPE_VALUES, a_ as SECURITY_FILTER_VALUES } from '../nitro/nitro.mjs';

//#region app/components/ColumnPicker.vue?vue&type=script&setup=true&lang.ts
var ColumnPicker_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(`<div${ssrRenderAttrs(mergeProps({ class: "relative" }, _attrs))} data-v-e3f99da5>`);
			...
			if (unref(isOpen)) {
				_push(`<div${ssrRenderAttr("id", unref(menuId))} class="absolute top-full inset-is-auto sm:inset-ie-0 mt-2 w-60 bg-bg-subtle border border-border rounded-lg shadow-lg z-20" role="group"${ssrRenderAttr("aria-label", unref($t)("filters.columns.show"))} data-v-e3f99da5><div class="py-1" data-v-e3f99da5><div class="px-3 py-2 text-xs font-mono text-fg-subtle uppercase tracking-wider border-b border-border" aria-hidden="true" data-v-e3f99da5>${ssrInterpolate(unref($t)("filters.columns.show"))}</div><div class="py-1 max-h-64 overflow-y-auto" data-v-e3f99da5><!--[-->`);
				ssrRenderList(unref(toggleableColumns), (column) => {
					_push(`<label class="${ssrRenderClass([column.disabled ? "opacity-50 cursor-not-allowed" : "hover:bg-bg-muted", "flex gap-2 items-center px-3 py-2 transition-colors duration-200"])}" data-v-e3f99da5><input type="checkbox"${ssrIncludeBooleanAttr(column.visible) ? " checked" : ""}${ssrIncludeBooleanAttr(column.disabled) ? " disabled" : ""}${ssrRenderAttr("aria-describedby", column.disabled ? `${column.id}-disabled-reason` : void 0)} class="w-4 h-4 accent-fg bg-bg-muted border-border rounded disabled:opacity-50" data-v-e3f99da5><span class="text-sm text-fg-muted font-mono flex-1" data-v-e3f99da5>${ssrInterpolate(getColumnLabel(column.id))}</span>`);
					if (column.disabled) _push(ssrRenderComponent(_component_TooltipApp, {
						...
						default: withCtx((_, _push, _parent, _scopeId) => {
							if (_push) _push(`<span class="size-4 flex justify-center items-center text-xs border rounded-full" data-v-e3f99da5${_scopeId}>i</span>`);
				...
				_push(`<!--]--></div><div class="border-t border-border p-2 pb-1" data-v-e3f99da5>`);
...
//#endregion
//#region app/components/ColumnPicker.vue
...
var ColumnPicker_default = /* @__PURE__ */ Object.assign(_plugin_vue_export_helper_default(ColumnPicker_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-e3f99da5"]]), { __name: "ColumnPicker" });
//#endregion
//#region app/components/ViewModeToggle.vue?vue&type=script&setup=true&lang.ts
var ViewModeToggle_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			}, _attrs))}><button type="button" class="${ssrRenderClass([viewMode.value === "cards" ? "bg-bg-subtle text-fg border-fg-subtle" : "text-fg-muted hover:text-fg border-transparent", "flex items-center px-2.5 py-2 text-sm font-medium rounded-sm border transition-colors duration-200 focus-visible:ring-2 focus-visible:ring-fg focus-visible:ring-offset-1"])}"${ssrRenderAttr("aria-pressed", viewMode.value === "cards")}${ssrRenderAttr("aria-label", _ctx.$t("filters.view_mode.cards"))}><span class="block i-lucide:rows-2 w-4 h-4" aria-hidden="true"></span><span class="sr-only">${ssrInterpolate(_ctx.$t("filters.view_mode.cards"))}</span></button><button type="button" class="${ssrRenderClass([viewMode.value === "table" ? "bg-bg-subtle  text-fg border-fg-subtle" : "text-fg-muted hover:text-fg border-transparent", "flex items-center px-2.5 py-2 text-sm font-medium rounded-sm border transition-colors duration-200 focus-visible:ring-2 focus-visible:ring-fg focus-visible:ring-offset-1"])}"${ssrRenderAttr("aria-pressed", viewMode.value === "table")}${ssrRenderAttr("aria-label", _ctx.$t("filters.view_mode.table"))}><span class="block i-lucide:table w-4 h-4" aria-hidden="true"></span><span class="sr-only">${ssrInterpolate(_ctx.$t("filters.view_mode.table"))}</span></button></div>`);
		};
	}
});
//#endregion
//#region app/components/ViewModeToggle.vue
...
//#endregion
//#region app/components/Tag/RadioButton.vue?vue&type=script&setup=true&lang.ts
...
//#endregion
//#region app/components/Tag/RadioButton.vue
...
//#endregion
//#region app/components/Filter/Panel.vue?vue&type=script&setup=true&lang.ts
var Panel_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			const _component_ButtonBase = Base_default$1;
			_push(`<div${ssrRenderAttrs(mergeProps({ class: "border border-border rounded-lg bg-bg-subtle" }, _attrs))} data-v-168a5220><button type="button" class="w-full flex items-center gap-3 px-4 py-3 text-start hover:bg-bg-muted transition-colors duration-200 focus-visible:ring-2 focus-visible:ring-fg focus-visible:ring-inset"${ssrRenderAttr("aria-expanded", unref(isExpanded))} data-v-168a5220><span class="flex items-center gap-2 text-sm font-mono text-fg shrink-0" data-v-168a5220><span class="i-lucide:funnel w-4 h-4" aria-hidden="true" data-v-168a5220></span> ${ssrInterpolate(unref($t)("filters.title"))}</span>`);
			if (!unref(isExpanded) && unref(hasActiveFilters)) _push(`<span class="text-xs font-mono text-fg-muted truncate" data-v-168a5220>${ssrInterpolate(unref(filterSummary))}</span>`);
			else _push(`<!---->`);
			_push(`<span class="${ssrRenderClass([{ "rotate-180": unref(isExpanded) }, "i-lucide:chevron-down w-4 h-4 text-fg-subtle transition-transform duration-200 shrink-0 ms-auto"])}" aria-hidden="true" data-v-168a5220></span></button>`);
			if (unref(isExpanded)) {
				_push(`<div class="px-4 pb-5 border-t border-border" data-v-168a5220><div class="pt-4" data-v-168a5220><div class="flex items-center gap-3 mb-1" data-v-168a5220><label for="filter-search" class="text-sm font-mono text-fg-muted" data-v-168a5220>${ssrInterpolate(unref($t)("filters.search"))}</label><div class="inline-flex rounded-md border border-border p-0.5 bg-bg-muted" role="group"${ssrRenderAttr("aria-label", unref($t)("filters.search_scope"))} data-v-168a5220><!--[-->`);
				ssrRenderList(unref(SEARCH_SCOPE_VALUES), (scope) => {
					_push(`<button type="button" class="${ssrRenderClass([__props.filters.searchScope === scope ? "bg-bg-subtle text-fg border-fg-subtle" : "text-fg-muted hover:text-fg border-transparent", "px-2 py-0.5 text-xs font-mono rounded-sm border transition-colors duration-200 focus-visible:ring-2 focus-visible:ring-fg focus-visible:ring-offset-1"])}"${ssrRenderAttr("aria-pressed", __props.filters.searchScope === scope)}${ssrRenderAttr("title", getScopeDescriptionKey(scope))} data-v-168a5220>${ssrInterpolate(getScopeLabelKey(scope))}</button>`);
				});
				_push(`<!--]--></div></div>`);
				...
				_push(`<!--]--></div></fieldset><fieldset class="border-0 p-0 m-0 mt-4" data-v-168a5220><legend class="block text-sm font-mono text-fg-muted mb-1" data-v-168a5220>${ssrInterpolate(unref($t)("filters.updated_within"))}</legend><div class="flex flex-wrap gap-2" role="radiogroup"${ssrRenderAttr("aria-label", unref($t)("filters.updated_within"))} data-v-168a5220><!--[-->`);
				...
				_push(`<!--]--></div></fieldset><fieldset class="border-0 p-0 m-0 mt-4" data-v-168a5220><legend class="flex items-center gap-2 text-sm font-mono text-fg-muted mb-1" data-v-168a5220>${ssrInterpolate(unref($t)("filters.security"))} <span class="text-xs px-1.5 py-0.5 rounded bg-bg-muted text-fg-subtle" data-v-168a5220>${ssrInterpolate(unref($t)("filters.columns.coming_soon"))}</span></legend><div class="flex flex-wrap gap-2" role="radiogroup"${ssrRenderAttr("aria-label", unref($t)("filters.security"))} data-v-168a5220><!--[-->`);
				...
				if (unref(displayedKeywords).length > 0) {
					_push(`<fieldset class="border-0 p-0 m-0 mt-4" data-v-168a5220><legend class="block text-sm font-mono text-fg-muted mb-1" data-v-168a5220>${ssrInterpolate(unref($t)("filters.keywords"))}</legend><div class="flex flex-wrap gap-1.5" role="group"${ssrRenderAttr("aria-label", unref($t)("filters.keywords"))} data-v-168a5220><!--[-->`);
...
//#endregion
//#region app/components/Filter/Panel.vue
...
var Panel_default = /* @__PURE__ */ Object.assign(_plugin_vue_export_helper_default(Panel_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-168a5220"]]), { __name: "FilterPanel" });
//#endregion
//#region app/components/Filter/Chips.vue?vue&type=script&setup=true&lang.ts
...
//#endregion
//#region app/components/Filter/Chips.vue
...
//#endregion
//#region app/components/Package/ListToolbar.vue?vue&type=script&setup=true&lang.ts
	...
	setup(__props, { emit: __emit }) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			if ((viewMode.value === "table" || paginationMode.value === "paginated") && !__props.searchContext) _push(`<div class="text-sm font-mono text-fg-muted">${ssrInterpolate(_ctx.$t("filters.count.showing_paginated", {
				pageSize: Math.min(pageSize.value, __props.filteredCount),
			...
			if (unref(selectedPackages).length) {
				_push(`<div class="flex items-center order-3 sm:border-is sm:border-fg-subtle/20 sm:ps-3">`);
				_push(ssrRenderComponent(_component_ButtonBase, {
					variant: "secondary",
					onClick: ($event) => emit("toggleSelection"),
					classicon: "i-lucide:package-check"
				}, {
					default: withCtx((_, _push, _parent, _scopeId) => {
						if (_push) _push(`${ssrInterpolate(unref(t)("filters.view_selected"))} (${ssrInterpolate(unref(selectedPackages).length)}) `);
						else return [createTextVNode(toDisplayString(unref(t)("filters.view_selected")) + " (" + toDisplayString(unref(selectedPackages).length) + ") ", 1)];
					}),
					_: 1
				}, _parent));
				_push(`<button${ssrRenderAttr("aria-label", _ctx.$t("filters.clear_selected_label"))} class="flex items-center ms-2"><span class="i-lucide:x text-sm"></span></button></div>`);
			} else _push(`<!---->`);
			_push(`</div></div>`);
...
//#endregion
//#region app/components/Package/ListToolbar.vue
...
//#endregion
//#region app/components/PaginationControls.vue?vue&type=script&setup=true&lang.ts
			...
			if (unref(shouldShowControls)) {
				...
				if (unref(effectiveMode) === "paginated") {
					...
					_push(ssrRenderComponent(_component_SelectField, {
						...
						items: unref(PAGE_SIZE_OPTIONS).map((size) => ({
							label: _ctx.$t("filters.pagination.per_page", { count: _ctx.$n(size) }),
							value: String(size)
						}))
					}, null, _parent));
					_push(`</div>`);
				...
				if (unref(effectiveMode) === "paginated") {
					_push(`<div class="flex items-center gap-4"><span class="text-sm font-mono text-fg-muted">${ssrInterpolate(_ctx.$t("filters.pagination.showing", {
						range: unref(numberFormatter).formatRange(unref(startItem), unref(endItem)),
					...
					if (unref(totalPages) > 1) {
						...
						ssrRenderList(unref(visiblePages), (page, idx) => {
							...
							else _push(`<button type="button" class="${ssrRenderClass([page === currentPage.value ? "bg-fg text-bg" : "text-fg-muted hover:text-fg hover:bg-bg-muted", "min-w-[32px] h-8 px-2 font-mono text-sm rounded transition-colors duration-200 focus-visible:ring-2 focus-visible:ring-fg focus-visible:ring-offset-1"])}"${ssrRenderAttr("aria-current", page === currentPage.value ? "page" : void 0)}>${ssrInterpolate(_ctx.$n(page))}</button>`);
							_push(`<!--]-->`);
						});
...
//#endregion
//#region app/components/PaginationControls.vue
...
//#endregion
//#region app/composables/usePackageListPreferences.ts
/**
...
function usePackageListPreferences() {
	...
	watch(isHydrated, (hydrated) => {
		if (!hydrated) return;
		if (preferences.value.pageSize === "all") {
			preferences.value.pageSize = Math.max(...PAGE_SIZE_OPTIONS);
			save();
		}
	}, { immediate: true });
...
//#endregion
//#region app/composables/useStructuredFilters.ts
/**
...
//# sourceMappingURL=useStructuredFilters-BE3XWvuQ.mjs.map
