...
var version = "版本";
var built_at = "建置於 {0}";
var alt_logo = "npmx 標誌";
var tagline = "更好的 npm 套件註冊表瀏覽工具";
var non_affiliation_disclaimer = "與 npm, Inc. 無任何隸屬關係";
var trademark_disclaimer = "npm 是 npm, Inc. 的註冊商標。本網站與 npm, Inc. 無任何隸屬關係。";
var footer = {
	about: "關於",
	docs: "文件",
	source: "原始碼",
...
var settings = {
	...
	relative_dates: "相對時間",
	relative_dates_description: "顯示「3 天前」而非完整日期",
...
var connector = {
	status: {
		connecting: "連線中…",
		connected_as: "已連線為 ~{user}",
		connected: "已連線",
		connect_cli: "連線本機 CLI",
		aria_connecting: "正在連線到本機連線器",
		aria_connected: "已連線到本機連線器",
		aria_click_to_connect: "點擊以連線到本機連線器",
		avatar_alt: "{user} 的頭像"
	},
	modal: {
		title: "本機連線器",
...
const zhTW = {
	...
	vulnerabilities: {
		...
		found: "{count} 個漏洞",
		deps_found: "{count} 個漏洞",
		deps_affected: "{count} 個受影響的相依套件",
		tree_found: "在 {packages}/{total} 個套件中發現 {vulns} 個漏洞",
		scanning_tree: "正在掃描相依樹…",
...
export { about, account_menu, alt_logo, auth, badges, built_at, claim, code, common, compare, connector, zhTW as default, filters, footer, header, i18n, nav, non_affiliation_disclaimer, operations, org, search, seo, settings, tagline, trademark_disclaimer, user, version };
