...
var version = "Version";
var built_at = "compilé {0}";
var alt_logo = "Logo npmx";
var tagline = "un meilleur explorateur du registre npm";
var non_affiliation_disclaimer = "non affilié à npm, Inc.";
var trademark_disclaimer = "npm est une marque déposée de npm, Inc. Ce site n'est pas affilié à npm, Inc.";
var footer = {
	about: "à propos",
	docs: "docs",
	source: "source",
...
var compare = {
	...
	no_dependency: {
		...
		typeahead_description: "Comparer avec l'absence de dépendance ! Approuvé par e18e.",
		tooltip_title: "Vous n'avez peut-être pas besoin d'une dépendance",
		tooltip_description: "Comparer avec l'absence de dépendance ! La {link} maintient une liste de paquets pouvant être remplacés par des API natives ou des alternatives plus simples.",
		e18e_community: "communauté e18e",
...
const frFR = {
	...
	vulnerabilities: {
		...
		deps_found: "{count} vulnérabilité trouvée | {count} vulnérabilités trouvées",
		deps_affected: "{count} dépendance affectée | {count} dépendances affectées",
		tree_found: "{vulns} vulnérabilité dans {packages}/{total} paquets | {vulns} vulnérabilités dans {packages}/{total} paquets",
		scanning_tree: "Analyse de l'arbre des dépendances...",
		show_all_packages: "afficher les {count} paquets affectés",
		no_summary: "Aucun résumé",
		view_details: "Voir les détails de la vulnérabilité",
		path: "chemin",
		more: "+{count} de plus",
		packages_failed: "{count} paquet n'a pas pu être vérifié | {count} paquets n'ont pas pu être vérifiés",
		no_known: "Aucune vulnérabilité connue dans {count} paquets",
		scan_failed: "Impossible d'analyser les vulnérabilités",
		depth: {
			root: "Ce paquet",
			direct: "Dépendance directe",
			transitive: "Dépendance transitive (indirecte)"
		},
		severity: {
			critical: "critique",
			high: "élevée",
...
export { about, account_menu, alt_logo, auth, badges, built_at, claim, code, common, compare, connector, frFR as default, filters, footer, header, i18n, nav, non_affiliation_disclaimer, operations, org, search, seo, settings, tagline, trademark_disclaimer, user, version };
