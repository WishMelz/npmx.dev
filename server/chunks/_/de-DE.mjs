...
var version = "Version";
var built_at = "erstellt {0}";
var alt_logo = "npmx Logo";
var tagline = "ein besserer Browser für die npm Registry";
var non_affiliation_disclaimer = "nicht verbunden mit npm, Inc.";
var trademark_disclaimer = "npm ist eine eingetragene Marke von npm, Inc. Diese Seite ist nicht mit npm, Inc. verbunden.";
var footer = {
	about: "Über uns",
	docs: "Doku",
	source: "Quellcode",
...
var settings = {
	...
	relative_dates_description: "Zeige „vor 3 Tagen“ anstelle von vollständigen Datumsangaben an",
...
var connector = {
	status: {
		...
		aria_click_to_connect: "Klicken, um mit lokalem Connector zu verbinden",
		avatar_alt: "Avatar von {user}"
	},
	modal: {
...
var privacy_policy = {
	...
	cookies: {
		...
		types: {
			...
			separator: ":",
			cookie_vdpl: "__vdpl",
			cookie_vdpl_desc: "Dieser Cookie wird von unserem Hosting-Anbieter (Vercel) zum Schutz vor Skew-Effekten verwendet. Er stellt sicher, dass du Assets der korrekten Deployment-Version lädst, wenn während deines Besuchs ein neues Update veröffentlicht wird. Er dient nicht dem Tracking.",
			cookie_h3: "h3",
			cookie_h3_desc: "Dies ist unser sicheres Sitzungs-Cookie. Es speichert den OAuth-Access-Token, wenn du dein Atmosphere-Konto verbindest. Es ist unerlässlich, um deine authentifizierte Sitzung aufrechtzuerhalten."
		},
		local_storage: {
...
const deDE = {
	...
	replacement: {
		...
		none: "Dieses Paket wurde als nicht mehr nötig markiert, und seine Funktionen sind wahrscheinlich in allen Engines nativ verfügbar.",
	...
	stats: {
		...
		size_tooltip: {
			...
			total: "{size} Gesamtgröße nach dem Entpacken (inklusive aller {count} Abhängigkeiten für linux-x64)"
		}
	},
	skills: {
	...
	optional_dependencies: {
		title: "Optionale Abhängigkeiten ({count})",
	...
	vulnerabilities: {
		...
		deps_found: "{count} Sicherheitslücke gefunden | {count} Sicherheitslücken gefunden",
...
export { about, account_menu, alt_logo, auth, badges, built_at, claim, code, common, compare, connector, deDE as default, filters, footer, header, i18n, nav, non_affiliation_disclaimer, operations, org, privacy_policy, search, seo, settings, tagline, trademark_disclaimer, user, version };
