...
import { bI as main$8 } from '../nitro/nitro.mjs';
...
const postView = l.typedObject(
  ...
  l.object({
    cid: l.string({ format: "cid" }),
    uri: l.string({ format: "at-uri" }),
    debug: l.optional(l.unknownObject()),
    embed: l.optional(
      l.typedUnion(
        [
          l.typedRef((() => view$3)),
...
const generatorView = l.typedObject(
  ...
  l.object({
    ...
    indexedAt: l.string({ format: "datetime" }),
    likeCount: l.optional(l.integer({ minimum: 0 })),
    contentMode: l.optional(l.string()),
...
const chatPreference = l.typedObject(
  $nsid$3,
  "chatPreference",
  l.object({ push: l.boolean(), include: l.string() })
);
...
const filterablePreference = l.typedObject(
  $nsid$3,
  "filterablePreference",
  l.object({ list: l.boolean(), push: l.boolean(), include: l.string() })
);
l.typedObject(
  $nsid$3,
...
const mutedWord = l.typedObject(
  ...
  l.object({
    ...
    expiresAt: l.optional(l.string({ format: "datetime" })),
    actorTarget: l.optional(l.withDefault(l.string(), "all"))
  })
);
...
const threadViewPref = l.typedObject(
  $nsid,
  "threadViewPref",
  l.object({ sort: l.optional(l.string()) })
);
...
const profileAssociatedChat = l.typedObject(
  ...
  l.object({ allowIncoming: l.string() })
);
...
const profileAssociatedActivitySubscription = l.typedObject(
  $nsid,
  "profileAssociatedActivitySubscription",
  l.object({ allowSubscriptions: l.string() })
);
