...
var version = "版本";
var built_at = "构建于 {0}";
var alt_logo = "npmx 标志";
var tagline = "更好的 npm 仓库浏览工具";
var non_affiliation_disclaimer = "不与 npm, Inc. 有任何隶属关系";
var trademark_disclaimer = "npm 是 npm, Inc. 的注册商标。本网站不与 npm, Inc. 有任何隶属关系。";
var footer = {
	about: "关于",
	docs: "文档",
	source: "源码",
...
var settings = {
	...
	relative_dates: "相对时间",
	relative_dates_description: "显示“3 天前”而不是完整日期",
...
var connector = {
	status: {
		...
		aria_connected: "已连接到本地连接器",
		aria_click_to_connect: "点击连接到本地连接器",
		avatar_alt: "{user} 的头像"
	},
	modal: {
		title: "本地连接器",
...
var org = {
	...
	page: {
		...
		not_found: "未找到组织",
		not_found_message: "“{'@'}{name}” 组织在 npm 上不存在",
		filter_placeholder: "筛选 {count} 个包…"
	}
};
var user = {
	combobox: {
		add_to_org_hint: "（也会添加到组织）",
		press_enter_to_add: "按 Enter 添加 {'@'}{username}",
		default_placeholder: "用户名…",
		suggestions_label: "用户建议"
	},
	page: {
		packages_title: "软件包",
		no_packages: "未找到公开包",
...
var claim = {
	modal: {
		...
		preview_json: "预览 package.json",
		claim_button: "声明包名",
		publishing: "发布中…",
		checking: "检查可用性中…",
		failed_to_check: "检查名称可用性失败",
		failed_to_claim: "声明包名失败"
	}
};
var code = {
	files_label: "文件",
	...
	unavailable_hint: "文件可能太大或不可用",
	version_required: "需要版本来浏览代码",
	go_to_package: "跳转到包",
	loading_tree: "加载文件树中…",
	failed_to_load_tree: "加载此包版本的文件失败",
	back_to_package: "返回包",
	table: {
		name: "名称",
		size: "大小"
...
var about = {
	...
	what_we_are_not: {
		title: "我们不是什么",
		not_package_manager: "不是包管理器。",
		not_registry: "不是仓库。",
		registry_description: "我们不托管包。我们只是一种更好的浏览方式。",
...
var auth = {
	modal: {
		title: "Atmosphere",
		connected_as: "已连接为 {'@'}{handle}",
		disconnect: "断开连接",
		connect_prompt: "使用 Atmosphere 账户登录",
		handle_label: "账户代码",
...
const zhCN = {
	...
	versions: {
		...
		collapse: "折叠 {tag}",
		expand: "展开 {tag}",
		collapse_other: "折叠其他版本",
		expand_other: "展开其他版本",
		collapse_major: "折叠主版本 {major}",
		expand_major: "展开主版本 {major}",
		other_versions: "其他版本",
	...
	vulnerabilities: {
		...
		found: "{count} 个漏洞",
		deps_found: "{count} 个漏洞",
		deps_affected: "{count} 个受影响的依赖",
		tree_found: "在 {packages}/{total} 个包中发现 {vulns} 个漏洞",
		scanning_tree: "正在扫描依赖树…",
		show_all_packages: "显示全部 {count} 个受影响的包",
		no_summary: "没有总结",
		view_details: "查看漏洞详情",
		path: "路径",
		more: "+{count} 更多",
		packages_failed: "{count} 个包无法检查",
		no_known: "在 {count} 个包中未发现已知漏洞",
		scan_failed: "无法扫描漏洞",
		depth: {
			root: "此包",
			direct: "直接依赖",
	...
	access: {
		...
		no_access: "未配置团队权限",
		select_team_label: "选择团队",
		loading_teams: "加载团队中…",
		select_team: "选择团队",
		permission_label: "权限级别",
		permission: {
			read_only: "只读",
			read_write: "读写"
		},
	...
	list: {
		filter_label: "筛选包",
		filter_placeholder: "筛选包…",
		sort_label: "排序包",
		showing_count: "正在展示 {total} 中的 {filtered} 个包"
	},
	skeleton: {
		loading: "加载包详情",
		license: "许可证",
...
export { about, account_menu, alt_logo, auth, badges, built_at, claim, code, common, compare, connector, zhCN as default, filters, footer, header, i18n, nav, non_affiliation_disclaimer, operations, org, search, seo, settings, tagline, trademark_disclaimer, user, version };
