import { d as defineCachedEventHandler, z as CACHE_MAX_AGE_ONE_YEAR, g as getRouterParam, p as parsePackageParams, c as createError, A as ERROR_PACKAGE_VERSION_AND_FILE_FAILED, B as getLanguageFromPath, D as getPackageFileTree, F as resolveDependencyVersions, G as flattenFileTree, H as createImportResolver, I as highlightCode, u as fetchNpmPackage, J as parseRepositoryInfo, K as renderReadmeHtml, h as handleApiError } from '../../../../nitro/nitro.mjs';
import * as v from 'valibot';
import { b as PackageFileQuerySchema } from '../../../../_/package.mjs';
import 'lru-cache';
import '@unocss/core';
...
const ____pkg__get = defineCachedEventHandler(
  async (event) => {
    ...
    const versionSegments = (_c = fullPathAfterV == null ? void 0 : fullPathAfterV.split("/")) != null ? _c : [];
