import { d as defineCachedEventHandler, b as CACHE_MAX_AGE_ONE_HOUR, g as getRouterParam, c as createError } from '../../../../../nitro/nitro.mjs';
import 'lru-cache';
import '@unocss/core';
...
const packages_get = defineCachedEventHandler(
  ...
  },
  {
    ...
    getKey: (event) => {
      var _a;
      const org = (_a = getRouterParam(event, "org")) != null ? _a : "";
