import { d as defineCachedEventHandler, l as CACHE_MAX_AGE_ONE_DAY, g as getRouterParam, b9 as getGravatarFromUsername, c as createError, ba as ERROR_GRAVATAR_EMAIL_UNAVAILABLE, h as handleApiError, bb as ERROR_GRAVATAR_FETCH_FAILED } from '../../../nitro/nitro.mjs';
...
const _username__get = defineCachedEventHandler(
  ...
  },
  {
    ...
    getKey: (event) => {
      var _a;
      const username = (_a = getRouterParam(event, "username")) == null ? void 0 : _a.trim().toLowerCase();
