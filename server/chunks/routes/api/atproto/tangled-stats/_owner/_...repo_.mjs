...
const ____repo_ = defineCachedEventHandler(
  async (event) => {
    ...
    try {
      ...
      let stars = (starMatch == null ? void 0 : starMatch[1]) ? parseInt(starMatch[1], 10) : 0;
      let forks = 0;
      const atUri = atUriMatch == null ? void 0 : atUriMatch[1];
      if (atUri) {
        try {
          const constellation = new Constellation(cachedFetch);
          const { data: allLinks } = await constellation.getAllLinks(atUri);
          stars = (_c = (_b = (_a = allLinks.links["sh.tangled.feed.star"]) == null ? void 0 : _a[".subject"]) == null ? void 0 : _b.distinct_dids) != null ? _c : stars;
          forks = (_f = (_e = (_d = allLinks.links["sh.tangled.repo"]) == null ? void 0 : _d[".source"]) == null ? void 0 : _e.distinct_dids) != null ? _f : 0;
        } catch {
        }
      }
      return {
