import { j as defineEventHandler, g as getRouterParam, c as createError, am as PackageLikesUtils } from '../../../../nitro/nitro.mjs';
import 'lru-cache';
import '@unocss/core';
...
const ____pkg__get = defineEventHandler(async (event) => {
