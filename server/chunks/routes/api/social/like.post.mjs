import { e as eventHandlerWithOAuthSession, c as createError, an as throwOnMissingOAuthScope, ao as readBody, ap as PackageLikesUtils, as as PACKAGE_SUBJECT_REF, at as $build, aq as like, ar as LIKES_SCOPE } from '../../../nitro/nitro.mjs';
...
const like_post = eventHandlerWithOAuthSession(async (event, oAuthSession) => {
  ...
  const like$1 = $build({
    createdAt: toDatetimeString(/* @__PURE__ */ new Date()),
    subjectRef
  });
