import { d as defineCachedEventHandler, b as CACHE_MAX_AGE_ONE_HOUR, g as getRouterParam, c as createError, x as parsePackageParam, u as fetchNpmPackage, v as setHeader, z as CACHE_MAX_AGE_ONE_YEAR, h as handleApiError, a3 as ERROR_SKILLS_FETCH_FAILED, D as getPackageFileTree, a4 as findSkillDirs, a5 as fetchSkillsList, a6 as fetchSkillContent, a7 as ERROR_SKILL_NOT_FOUND, a8 as fetchSkillFile, a9 as ERROR_SKILL_FILE_NOT_FOUND } from '../../nitro/nitro.mjs';
  ...
  async (event) => {
    ...
    try {
      ...
      if (!version) {
        ...
        version = (_a = packument["dist-tags"]) == null ? void 0 : _a.latest;
        if (!version) {
