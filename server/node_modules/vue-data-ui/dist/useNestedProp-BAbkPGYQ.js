import { t as ft, w as ct } from "./lib-CM2Ky_IJ.js";
function gt(_ = {}) {
  const a = "#2D353C", A = "#A1A1A1", R = "#e1e5e8", c = "#CCCCCC", W = "#4A4A4A", l = "#FFFFFF", V = "#fafafa", f = "#1f77b4", z = "#d62728", O = "#2ca02c", E = "#42d392", N = "#FFD055", r = _.colorBackground ?? l, e = _.colorTextPrimary ?? a, T = _.colorTextSecondary ?? A, o = _.colorGrid ?? R, b = _.colorBorder ?? R, t = {
    _6: 6,
    _10: 10,
    _12: 12,
    _14: 14,
    ...
    teleportTo: "body"
    // or any other css selector (used in the `to` attr of the Teleport component)
  }, y = {
    enable: !1,
    locale: "en",
    useUTC: !1,
    ...
    return L || delete w.tooltip, B || delete w.pdf, H || delete w.csv, I || delete w.img, X || delete w.table, G || delete w.labels, U || delete w.fullscreen, $ || delete w.sort, j || delete w.stack, q || delete w.animation, Z || delete w.annotator, K || delete w.svg, Q || delete w.zoom, {
      show: !0,
      showOnChartHover: !1,
    ...
    style: {
      ...
      chart: {
        ...
        percentage: {
          ...
          bold: !0,
          rounding: 1,
          verticalPosition: m.BOTTOM,
          horizontalPosition: m.LEFT,
          formatter: null
        },
        title: s
      }
    ...
    showLegendSelectAllToggle: !1,
    legendSelectAllToggleBackgroundColor: b,
    legendSelectAllToggleColor: e,
    lineAnimated: !0,
    lineSmooth: !0,
    lineStrokeWidth: 2,
    paletteStartIndex: 0,
          ...
          donutChart: {
            ...
            style: {
              ...
              chart: {
                ...v.style.chart,
                layout: {
                  ...v.style.chart.layout,
                  donut: {
                    ...v.style.chart.layout.donut,
                    strokeWidth: 64
                  },
                  labels: {
                    ...v.style.chart.layout.labels,
                    percentage: {
                      ...v.style.chart.layout.labels.percentage,
                      fontSize: 16
                    },
                    name: {
                      ...v.style.chart.layout.labels.name,
                      fontSize: 12
                    },
                    hollow: {
                      ...v.style.chart.layout.labels.hollow,
                      average: {
                        ...v.style.chart.layout.labels.hollow.average,
                        show: !1
                      }
                    }
                  }
    ...
    thead: {
      ...
      tr: {
        ...
        style: {
          backgroundColor: r,
          color: e,
          boxShadow: `0px 6px 12px -6px ${a}50`
        },
        th: {
          border: {
            size: 0,
  ...
  return {
    ...
    vue_ui_chestnut: ue,
    vue_ui_onion: de,
    vue_ui_vertical_bar: Y,
    // deprecate in v4
    vue_ui_horizontal_bar: fe,
    // v3
    vue_ui_heatmap: ce,
    vue_ui_scatter: he,
    vue_ui_candlestick: ge,
    vue_ui_sparkline: pe,
    vue_ui_sparkbar: me,
    vue_ui_sparkstackbar: be,
    vue_ui_sparkhistogram: ke,
    vue_ui_sparkgauge: we,
    vue_ui_spark_trend: Ce,
    vue_ui_quick_chart: ye,
    vue_ui_age_pyramid: ve,
    vue_ui_relation_circle: xe,
    vue_ui_thermometer: Se,
    vue_ui_rings: _e,
    vue_ui_donut_evolution: ze,
    vue_ui_mood_radar: Le,
    vue_ui_molecule: Pe,
    vue_ui_nested_donuts: Ae,
    vue_ui_galaxy: Te,
    vue_ui_strip_plot: De,
    vue_ui_dumbbell: Oe,
    vue_ui_3d_bar: Fe,
    vue_ui_table_sparkline: Re,
    vue_ui_table_heatmap: We,
    vue_ui_word_cloud: Ve,
    vue_ui_xy_canvas: Ee,
    vue_ui_flow: Me,
    vue_ui_parallel_coordinate_plot: Ne,
    vue_ui_timer: Ye,
    vue_ui_carousel_table: Qe,
    vue_ui_gizmo: Je,
    vue_ui_stackbar: te,
    vue_ui_bullet: et,
    vue_ui_funnel: tt,
    vue_ui_history_plot: ot,
    vue_ui_world: lt,
    vue_ui_ridgeline: at,
    vue_ui_chord: st,
    vue_ui_stackline: ee,
    ...
    vue_ui_table: Ze,
    vue_ui_digits: Ke,
    vue_ui_circle_pack: rt
  };
}
function pt({ defaultConfig: _, userConfig: a }) {
