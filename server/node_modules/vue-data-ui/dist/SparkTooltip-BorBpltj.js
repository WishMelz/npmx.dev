import { toRef as c, ref as u, computed as v, onMounted as m, watch as y, openBlock as b, createElementBlock as g, normalizeStyle as x, renderSlot as k, nextTick as S } from "vue";
import { u as _, aw as i } from "./lib-DBptbyyI.js";
...
const R = {
  ...
  setup(d) {
    const e = d, a = c(e.svgRef), o = u(null), n = u(0), l = u(0), p = u(!1), f = v(() => _(e.background, e.backgroundOpacity)), s = async () => {
